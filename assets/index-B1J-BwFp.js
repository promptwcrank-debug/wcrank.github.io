 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Zs=new Map,xv=new Map,tc=new Map;function ed(n,e){try{n.container.addComponent(e)}catch(t){Ut.debug(`Component ${e.name} failed to register with FirebaseApp ${n.name}`,t)}}function gr(n){const e=n.name;if(tc.has(e))return Ut.debug(`There were multiple attempts to register component ${e}.`),!1;tc.set(e,n);for(const t of Zs.values())ed(t,n);for(const t of xv.values())ed(t,n);return!0}function Bc(n,e){const t=n.container.getProvider("heartbeat").getImmediate({optional:!0});return t&&t.triggerHeartbeat(),n.container.getProvider(e)}function pt(n){return n==null?!1:n.settings!==void 0}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cr=Tv;function af(n,e={}){let t=n;typeof e!="object"&&(e={name:e});const r=Object.assign({name:ec,automaticDataCollectionEnabled:!0},e),i=r.name;if(typeof i!="string"||!i)throw rn.create("bad-app-name",{appName:String(i)});if(t||(t=ef()),!t)throw rn.create("no-options");const s=Zs.get(i);if(s){if(Ln(t,s.options)&&Ln(r,s.config))return s;throw rn.create("duplicate-app",{appName:i})}const o=new Oy(i);for(const l of tc.values())o.addComponent(l);const c=new Sv(t,r,o);return Zs.set(i,c),c}function cf(n=ec){const e=Zs.get(n);if(!e&&n===ec&&ef())return af();if(!e)throw rn.create("no-app",{appName:n});return e}function sn(n,e,t){var r;let i=(r=Av[n])!==null&&r!==void 0?r:n;t&&(i+=`-${t}`);const s=i.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const c=[`Unable to register library "${i}" with version "${e}":`];s&&c.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),Ut.warn(c.join(" "));return}gr(new Mn(`${i}-version`,()=>({library:i,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Cv="firebase-heartbeat-database",Rv=1,_i="firebase-heartbeat-store";let Da=null;function lf(){return Da||(Da=Gy(Cv,Rv,{upgrade:(n,e)=>{switch(e){case 0:try{n.createObjectStore(_i)}catch(t){console.warn(t)}}}}).catch(n=>{throw rn.create("idb-open",{originalErrorMessage:n.message})})),Da}async function Pv(n){try{const t=(await lf()).transaction(_i),r=await t.objectStore(_i).get(uf(n));return await t.done,r}catch(e){if(e instanceof Wt)Ut.warn(e.message);else{const t=rn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});Ut.warn(t.message)}}}async function td(n,e){try{const r=(await lf()).transaction(_i,"readwrite");await r.objectStore(_i).put(e,uf(n)),await r.done}catch(t){if(t instanceof Wt)Ut.warn(t.message);else{const r=rn.create("idb-set",{originalErrorMessage:t==null?void 0:t.message});Ut.warn(r.message)}}}function uf(n){return`${n.name}!${n.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Fv(n){gr(new Mn("platform-logger",e=>new Yy(e),"PRIVATE")),gr(new Mn("heartbeat",e=>new Ov(e),"PRIVATE")),sn(Ja,Ju,n),sn(Ja,Ju,"esm2017"),sn("fire-js","")}Fv("");var Bv="firebase",Uv="11.10.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */sn(Bv,Uv,"app");var id=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
...
*/var on,df;(function(){var n;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(I,v){function w(){}w.prototype=v.prototype,I.D=v.prototype,I.prototype=new w,I.prototype.constructor=I,I.C=function(T,b,k){for(var E=Array(arguments.length-2),Re=2;Re<arguments.length;Re++)E[Re-2]=arguments[Re];return v.prototype[b].apply(T,E)}}function t(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(r,t),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function i(I,v,w){w||(w=0);var T=Array(16);if(typeof v=="string")for(var b=0;16>b;++b)T[b]=v.charCodeAt(w++)|v.charCodeAt(w++)<<8|v.charCodeAt(w++)<<16|v.charCodeAt(w++)<<24;else for(b=0;16>b;++b)T[b]=v[w++]|v[w++]<<8|v[w++]<<16|v[w++]<<24;v=I.g[0],w=I.g[1],b=I.g[2];var k=I.g[3],E=v+(k^w&(b^k))+T[0]+3614090360&4294967295;v=w+(E<<7&4294967295|E>>>25),E=k+(b^v&(w^b))+T[1]+3905402710&4294967295,k=v+(E<<12&4294967295|E>>>20),E=b+(w^k&(v^w))+T[2]+606105819&4294967295,b=k+(E<<17&4294967295|E>>>15),E=w+(v^b&(k^v))+T[3]+3250441966&4294967295,w=b+(E<<22&4294967295|E>>>10),E=v+(k^w&(b^k))+T[4]+4118548399&4294967295,v=w+(E<<7&4294967295|E>>>25),E=k+(b^v&(w^b))+T[5]+1200080426&4294967295,k=v+(E<<12&4294967295|E>>>20),E=b+(w^k&(v^w))+T[6]+2821735955&4294967295,b=k+(E<<17&4294967295|E>>>15),E=w+(v^b&(k^v))+T[7]+4249261313&4294967295,w=b+(E<<22&4294967295|E>>>10),E=v+(k^w&(b^k))+T[8]+1770035416&4294967295,v=w+(E<<7&4294967295|E>>>25),E=k+(b^v&(w^b))+T[9]+2336552879&4294967295,k=v+(E<<12&4294967295|E>>>20),E=b+(w^k&(v^w))+T[10]+4294925233&4294967295,b=k+(E<<17&4294967295|E>>>15),E=w+(v^b&(k^v))+T[11]+2304563134&4294967295,w=b+(E<<22&4294967295|E>>>10),E=v+(k^w&(b^k))+T[12]+1804603682&4294967295,v=w+(E<<7&4294967295|E>>>25),E=k+(b^v&(w^b))+T[13]+4254626195&4294967295,k=v+(E<<12&4294967295|E>>>20),E=b+(w^k&(v^w))+T[14]+2792965006&4294967295,b=k+(E<<17&4294967295|E>>>15),E=w+(v^b&(k^v))+T[15]+1236535329&4294967295,w=b+(E<<22&4294967295|E>>>10),E=v+(b^k&(w^b))+T[1]+4129170786&4294967295,v=w+(E<<5&4294967295|E>>>27),E=k+(w^b&(v^w))+T[6]+3225465664&4294967295,k=v+(E<<9&4294967295|E>>>23),E=b+(v^w&(k^v))+T[11]+643717713&4294967295,b=k+(E<<14&4294967295|E>>>18),E=w+(k^v&(b^k))+T[0]+3921069994&4294967295,w=b+(E<<20&4294967295|E>>>12),E=v+(b^k&(w^b))+T[5]+3593408605&4294967295,v=w+(E<<5&4294967295|E>>>27),E=k+(w^b&(v^w))+T[10]+38016083&4294967295,k=v+(E<<9&4294967295|E>>>23),E=b+(v^w&(k^v))+T[15]+3634488961&4294967295,b=k+(E<<14&4294967295|E>>>18),E=w+(k^v&(b^k))+T[4]+3889429448&4294967295,w=b+(E<<20&4294967295|E>>>12),E=v+(b^k&(w^b))+T[9]+568446438&4294967295,v=w+(E<<5&4294967295|E>>>27),E=k+(w^b&(v^w))+T[14]+3275163606&4294967295,k=v+(E<<9&4294967295|E>>>23),E=b+(v^w&(k^v))+T[3]+4107603335&4294967295,b=k+(E<<14&4294967295|E>>>18),E=w+(k^v&(b^k))+T[8]+1163531501&4294967295,w=b+(E<<20&4294967295|E>>>12),E=v+(b^k&(w^b))+T[13]+2850285829&4294967295,v=w+(E<<5&4294967295|E>>>27),E=k+(w^b&(v^w))+T[2]+4243563512&4294967295,k=v+(E<<9&4294967295|E>>>23),E=b+(v^w&(k^v))+T[7]+1735328473&4294967295,b=k+(E<<14&4294967295|E>>>18),E=w+(k^v&(b^k))+T[12]+2368359562&4294967295,w=b+(E<<20&4294967295|E>>>12),E=v+(w^b^k)+T[5]+4294588738&4294967295,v=w+(E<<4&4294967295|E>>>28),E=k+(v^w^b)+T[8]+2272392833&4294967295,k=v+(E<<11&4294967295|E>>>21),E=b+(k^v^w)+T[11]+1839030562&4294967295,b=k+(E<<16&4294967295|E>>>16),E=w+(b^k^v)+T[14]+4259657740&4294967295,w=b+(E<<23&4294967295|E>>>9),E=v+(w^b^k)+T[1]+2763975236&4294967295,v=w+(E<<4&4294967295|E>>>28),E=k+(v^w^b)+T[4]+1272893353&4294967295,k=v+(E<<11&4294967295|E>>>21),E=b+(k^v^w)+T[7]+4139469664&4294967295,b=k+(E<<16&4294967295|E>>>16),E=w+(b^k^v)+T[10]+3200236656&4294967295,w=b+(E<<23&4294967295|E>>>9),E=v+(w^b^k)+T[13]+681279174&4294967295,v=w+(E<<4&4294967295|E>>>28),E=k+(v^w^b)+T[0]+3936430074&4294967295,k=v+(E<<11&4294967295|E>>>21),E=b+(k^v^w)+T[3]+3572445317&4294967295,b=k+(E<<16&4294967295|E>>>16),E=w+(b^k^v)+T[6]+76029189&4294967295,w=b+(E<<23&4294967295|E>>>9),E=v+(w^b^k)+T[9]+3654602809&4294967295,v=w+(E<<4&4294967295|E>>>28),E=k+(v^w^b)+T[12]+3873151461&4294967295,k=v+(E<<11&4294967295|E>>>21),E=b+(k^v^w)+T[15]+530742520&4294967295,b=k+(E<<16&4294967295|E>>>16),E=w+(b^k^v)+T[2]+3299628645&4294967295,w=b+(E<<23&4294967295|E>>>9),E=v+(b^(w|~k))+T[0]+4096336452&4294967295,v=w+(E<<6&4294967295|E>>>26),E=k+(w^(v|~b))+T[7]+1126891415&4294967295,k=v+(E<<10&4294967295|E>>>22),E=b+(v^(k|~w))+T[14]+2878612391&4294967295,b=k+(E<<15&4294967295|E>>>17),E=w+(k^(b|~v))+T[5]+4237533241&4294967295,w=b+(E<<21&4294967295|E>>>11),E=v+(b^(w|~k))+T[12]+1700485571&4294967295,v=w+(E<<6&4294967295|E>>>26),E=k+(w^(v|~b))+T[3]+2399980690&4294967295,k=v+(E<<10&4294967295|E>>>22),E=b+(v^(k|~w))+T[10]+4293915773&4294967295,b=k+(E<<15&4294967295|E>>>17),E=w+(k^(b|~v))+T[1]+2240044497&4294967295,w=b+(E<<21&4294967295|E>>>11),E=v+(b^(w|~k))+T[8]+1873313359&4294967295,v=w+(E<<6&4294967295|E>>>26),E=k+(w^(v|~b))+T[15]+4264355552&4294967295,k=v+(E<<10&4294967295|E>>>22),E=b+(v^(k|~w))+T[6]+2734768916&4294967295,b=k+(E<<15&4294967295|E>>>17),E=w+(k^(b|~v))+T[13]+1309151649&4294967295,w=b+(E<<21&4294967295|E>>>11),E=v+(b^(w|~k))+T[4]+4149444226&4294967295,v=w+(E<<6&4294967295|E>>>26),E=k+(w^(v|~b))+T[11]+3174756917&4294967295,k=v+(E<<10&4294967295|E>>>22),E=b+(v^(k|~w))+T[2]+718787259&4294967295,b=k+(E<<15&4294967295|E>>>17),E=w+(k^(b|~v))+T[9]+3951481745&4294967295,I.g[0]=I.g[0]+v&4294967295,I.g[1]=I.g[1]+(b+(E<<21&4294967295|E>>>11))&4294967295,I.g[2]=I.g[2]+b&4294967295,I.g[3]=I.g[3]+k&4294967295}r.prototype.u=function(I,v){v===void 0&&(v=I.length);for(var w=v-this.blockSize,T=this.B,b=this.h,k=0;k<v;){if(b==0)for(;k<=w;)i(this,I,k),k+=this.blockSize;if(typeof I=="string"){for(;k<v;)if(T[b++]=I.charCodeAt(k++),b==this.blockSize){i(this,T),b=0;break}}else for(;k<v;)if(T[b++]=I[k++],b==this.blockSize){i(this,T),b=0;break}}this.h=b,this.o+=v},r.prototype.v=function(){var I=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);I[0]=128;for(var v=1;v<I.length-8;++v)I[v]=0;var w=8*this.o;for(v=I.length-8;v<I.length;++v)I[v]=w&255,w/=256;for(this.u(I),I=Array(16),v=w=0;4>v;++v)for(var T=0;32>T;T+=8)I[w++]=this.g[v]>>>T&255;return I};function s(I,v){var w=c;return Object.prototype.hasOwnProperty.call(w,I)?w[I]:w[I]=v(I)}function o(I,v){this.h=v;for(var w=[],T=!0,b=I.length-1;0<=b;b--){var k=I[b]|0;T&&k==v||(w[b]=k,T=!1)}this.g=w}var c={};function l(I){return-128<=I&&128>I?s(I,function(v){return new o([v|0],0>v?-1:0)}):new o([I|0],0>I?-1:0)}function d(I){if(isNaN(I)||!isFinite(I))return p;if(0>I)return A(d(-I));for(var v=[],w=1,T=0;I>=w;T++)v[T]=I/w|0,w*=4294967296;return new o(v,0)}function f(I,v){if(I.length==0)throw Error("number format error: empty string");if(v=v||10,2>v||36<v)throw Error("radix out of range: "+v);if(I.charAt(0)=="-")return A(f(I.substring(1),v));if(0<=I.indexOf("-"))throw Error('number format error: interior "-" character');for(var w=d(Math.pow(v,8)),T=p,b=0;b<I.length;b+=8){var k=Math.min(8,I.length-b),E=parseInt(I.substring(b,b+k),v);8>k?(k=d(Math.pow(v,k)),T=T.j(k).add(d(E))):(T=T.j(w),T=T.add(d(E)))}return T}var p=l(0),m=l(1),_=l(16777216);n=o.prototype,n.m=function(){if(x(this))return-A(this).m();for(var I=0,v=1,w=0;w<this.g.length;w++){var T=this.i(w);I+=(0<=T?T:4294967296+T)*v,v*=4294967296}return I},n.toString=function(I){if(I=I||10,2>I||36<I)throw Error("radix out of range: "+I);if(C(this))return"0";if(x(this))return"-"+A(this).toString(I);for(var v=d(Math.pow(I,6)),w=this,T="";;){var b=q(w,v).g;w=N(w,b.j(v));var k=((0<w.g.length?w.g[0]:w.h)>>>0).toString(I);if(w=b,C(w))return k+T;for(;6>k.length;)k="0"+k;T=k+T}},n.i=function(I){return 0>I?0:I<this.g.length?this.g[I]:this.h};function C(I){if(I.h!=0)return!1;for(var v=0;v<I.g.length;v++)if(I.g[v]!=0)return!1;return!0}function x(I){return I.h==-1}n.l=function(I){return I=N(this,I),x(I)?-1:C(I)?0:1};function A(I){for(var v=I.g.length,w=[],T=0;T<v;T++)w[T]=~I.g[T];return new o(w,~I.h).add(m)}n.abs=function(){return x(this)?A(this):this},n.add=function(I){for(var v=Math.max(this.g.length,I.g.length),w=[],T=0,b=0;b<=v;b++){var k=T+(this.i(b)&65535)+(I.i(b)&65535),E=(k>>>16)+(this.i(b)>>>16)+(I.i(b)>>>16);T=E>>>16,k&=65535,E&=65535,w[b]=E<<16|k}return new o(w,w[w.length-1]&-2147483648?-1:0)};function N(I,v){return I.add(A(v))}n.j=function(I){if(C(this)||C(I))return p;if(x(this))return x(I)?A(this).j(A(I)):A(A(this).j(I));if(x(I))return A(this.j(A(I)));if(0>this.l(_)&&0>I.l(_))return d(this.m()*I.m());for(var v=this.g.length+I.g.length,w=[],T=0;T<2*v;T++)w[T]=0;for(T=0;T<this.g.length;T++)for(var b=0;b<I.g.length;b++){var k=this.i(T)>>>16,E=this.i(T)&65535,Re=I.i(b)>>>16,Qe=I.i(b)&65535;w[2*T+2*b]+=E*Qe,O(w,2*T+2*b),w[2*T+2*b+1]+=k*Qe,O(w,2*T+2*b+1),w[2*T+2*b+1]+=E*Re,O(w,2*T+2*b+1),w[2*T+2*b+2]+=k*Re,O(w,2*T+2*b+2)}for(T=0;T<v;T++)w[T]=w[2*T+1]<<16|w[2*T];for(T=v;T<2*v;T++)w[T]=0;return new o(w,0)};function O(I,v){for(;(I[v]&65535)!=I[v];)I[v+1]+=I[v]>>>16,I[v]&=65535,v++}function B(I,v){this.g=I,this.h=v}function q(I,v){if(C(v))throw Error("division by zero");if(C(I))return new B(p,p);if(x(I))return v=q(A(I),v),new B(A(v.g),A(v.h));if(x(v))return v=q(I,A(v)),new B(A(v.g),v.h);if(30<I.g.length){if(x(I)||x(v))throw Error("slowDivide_ only works with positive integers.");for(var w=m,T=v;0>=T.l(I);)w=fe(w),T=fe(T);var b=ie(w,1),k=ie(T,1);for(T=ie(T,2),w=ie(w,2);!C(T);){var E=k.add(T);0>=E.l(I)&&(b=b.add(w),k=E),T=ie(T,1),w=ie(w,1)}return v=N(I,b.j(v)),new B(b,v)}for(b=p;0<=I.l(v);){for(w=Math.max(1,Math.floor(I.m()/v.m())),T=Math.ceil(Math.log(w)/Math.LN2),T=48>=T?1:Math.pow(2,T-48),k=d(w),E=k.j(v);x(E)||0<E.l(I);)w-=T,k=d(w),E=k.j(v);C(k)&&(k=m),b=b.add(k),I=N(I,E)}return new B(b,I)}n.A=function(I){return q(this,I).h},n.and=function(I){for(var v=Math.max(this.g.length,I.g.length),w=[],T=0;T<v;T++)w[T]=this.i(T)&I.i(T);return new o(w,this.h&I.h)},n.or=function(I){for(var v=Math.max(this.g.length,I.g.length),w=[],T=0;T<v;T++)w[T]=this.i(T)|I.i(T);return new o(w,this.h|I.h)},n.xor=function(I){for(var v=Math.max(this.g.length,I.g.length),w=[],T=0;T<v;T++)w[T]=this.i(T)^I.i(T);return new o(w,this.h^I.h)};function fe(I){for(var v=I.g.length+1,w=[],T=0;T<v;T++)w[T]=I.i(T)<<1|I.i(T-1)>>>31;return new o(w,I.h)}function ie(I,v){var w=v>>5;v%=32;for(var T=I.g.length-w,b=[],k=0;k<T;k++)b[k]=0<v?I.i(k+w)>>>v|I.i(k+w+1)<<32-v:I.i(k+w);return new o(b,I.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,df=r,o.prototype.add=o.prototype.add,o.prototype.multiply=o.prototype.j,o.prototype.modulo=o.prototype.A,o.prototype.compare=o.prototype.l,o.prototype.toNumber=o.prototype.m,o.prototype.toString=o.prototype.toString,o.prototype.getBits=o.prototype.i,o.fromNumber=d,o.fromString=f,on=o}).apply(typeof id<"u"?id:typeof self<"u"?self:typeof window<"u"?window:{});var ks=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
*/var hf,ri,ff,Os,nc,pf,mf,gf;(function(){var n,e=typeof Object.defineProperties=="function"?Object.defineProperty:function(a,u,h){return a==Array.prototype||a==Object.prototype||(a[u]=h.value),a};function t(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof ks=="object"&&ks];for(var u=0;u<a.length;++u){var h=a[u];if(h&&h.Math==Math)return h}throw Error("Cannot find global object")}var r=t(this);function i(a,u){if(u)e:{var h=r;a=a.split(".");for(var g=0;g<a.length-1;g++){var S=a[g];if(!(S in h))break e;h=h[S]}a=a[a.length-1],g=h[a],u=u(g),u!=g&&u!=null&&e(h,a,{configurable:!0,writable:!0,value:u})}}function s(a,u){a instanceof String&&(a+="");var h=0,g=!1,S={next:function(){if(!g&&h<a.length){var R=h++;return{value:u(R,a[R]),done:!1}}return g=!0,{done:!0,value:void 0}}};return S[Symbol.iterator]=function(){return S},S}i("Array.prototype.values",function(a){return a||function(){return s(this,function(u,h){return h})}});/** @license

 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var o=o||{},c=this||self;function l(a){var u=typeof a;return u=u!="object"?u:a?Array.isArray(a)?"array":u:"null",u=="array"||u=="object"&&typeof a.length=="number"}function d(a){var u=typeof a;return u=="object"&&a!=null||u=="function"}function f(a,u,h){return a.call.apply(a.bind,arguments)}function p(a,u,h){if(!a)throw Error();if(2<arguments.length){var g=Array.prototype.slice.call(arguments,2);return function(){var S=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(S,g),a.apply(u,S)}}return function(){return a.apply(u,arguments)}}function m(a,u,h){return m=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?f:p,m.apply(null,arguments)}function _(a,u){var h=Array.prototype.slice.call(arguments,1);return function(){var g=h.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function C(a,u){function h(){}h.prototype=u.prototype,a.aa=u.prototype,a.prototype=new h,a.prototype.constructor=a,a.Qb=function(g,S,R){for(var L=Array(arguments.length-2),pe=2;pe<arguments.length;pe++)L[pe-2]=arguments[pe];return u.prototype[S].apply(g,L)}}function x(a){const u=a.length;if(0<u){const h=Array(u);for(let g=0;g<u;g++)h[g]=a[g];return h}return[]}function A(a,u){for(let h=1;h<arguments.length;h++){const g=arguments[h];if(l(g)){const S=a.length||0,R=g.length||0;a.length=S+R;for(let L=0;L<R;L++)a[S+L]=g[L]}else a.push(g)}}class N{constructor(u,h){this.i=u,this.j=h,this.h=0,this.g=null}get(){let u;return 0<this.h?(this.h--,u=this.g,this.g=u.next,u.next=null):u=this.i(),u}}function O(a){return/^[\s\xa0]*$/.test(a)}function B(){var a=c.navigator;return a&&(a=a.userAgent)?a:""}function q(a){return q[" "](a),a}q[" "]=function(){};var fe=B().indexOf("Gecko")!=-1&&!(B().toLowerCase().indexOf("webkit")!=-1&&B().indexOf("Edge")==-1)&&!(B().indexOf("Trident")!=-1||B().indexOf("MSIE")!=-1)&&B().indexOf("Edge")==-1;function ie(a,u,h){for(const g in a)u.call(h,a[g],g,a)}function I(a,u){for(const h in a)u.call(void 0,a[h],h,a)}function v(a){const u={};for(const h in a)u[h]=a[h];return u}const w="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function T(a,u){let h,g;for(let S=1;S<arguments.length;S++){g=arguments[S];for(h in g)a[h]=g[h];for(let R=0;R<w.length;R++)h=w[R],Object.prototype.hasOwnProperty.call(g,h)&&(a[h]=g[h])}}function b(a){var u=1;a=a.split(":");const h=[];for(;0<u&&a.length;)h.push(a.shift()),u--;return a.length&&h.push(a.join(":")),h}function k(a){c.setTimeout(()=>{throw a},0)}function E(){var a=Ur;let u=null;return a.g&&(u=a.g,a.g=a.g.next,a.g||(a.h=null),u.next=null),u}class Re{constructor(){this.h=this.g=null}add(u,h){const g=Qe.get();g.set(u,h),this.h?this.h.next=g:this.g=g,this.h=g}}var Qe=new N(()=>new ct,a=>a.reset());class ct{constructor(){this.next=this.g=this.h=null}set(u,h){this.h=u,this.g=h,this.next=null}reset(){this.next=this.g=this.h=null}}let In,Wn=!1,Ur=new Re,Tn=()=>{const a=c.Promise.resolve(void 0);In=()=>{a.then(Gn)}};var Gn=()=>{for(var a;a=E();){try{a.h.call(a.g)}catch(h){k(h)}var u=Qe;u.j(a),100>u.h&&(u.h++,a.next=u.g,u.g=a)}Wn=!1};function dt(){this.s=this.s,this.C=this.C}dt.prototype.s=!1,dt.prototype.ma=function(){this.s||(this.s=!0,this.N())},dt.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function xe(a,u){this.type=a,this.g=this.target=u,this.defaultPrevented=!1}xe.prototype.h=function(){this.defaultPrevented=!0};var $r=(function(){if(!c.addEventListener||!Object.defineProperty)return!1;var a=!1,u=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const h=()=>{};c.addEventListener("test",h,u),c.removeEventListener("test",h,u)}catch{}return a})();function Kn(a,u){if(xe.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a){var h=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;if(this.target=a.target||a.srcElement,this.g=u,u=a.relatedTarget){if(fe){e:{try{q(u.nodeName);var S=!0;break e}catch{}S=!1}S||(u=null)}}else h=="mouseover"?u=a.fromElement:h=="mouseout"&&(u=a.toElement);this.relatedTarget=u,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=typeof a.pointerType=="string"?a.pointerType:ls[a.pointerType]||"",this.state=a.state,this.i=a,a.defaultPrevented&&Kn.aa.h.call(this)}}C(Kn,xe);var ls={2:"touch",3:"pen",4:"mouse"};Kn.prototype.h=function(){Kn.aa.h.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var An="closure_listenable_"+(1e6*Math.random()|0),Kl=0;function aa(a,u,h,g,S){this.listener=a,this.proxy=null,this.src=u,this.type=h,this.capture=!!g,this.ha=S,this.key=++Kl,this.da=this.fa=!1}function xn(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Pt(a){this.src=a,this.g={},this.h=0}Pt.prototype.add=function(a,u,h,g,S){var R=a.toString();a=this.g[R],a||(a=this.g[R]=[],this.h++);var L=_t(a,u,g,S);return-1<L?(u=a[L],h||(u.fa=!1)):(u=new aa(u,this.src,R,!!g,S),u.fa=h,a.push(u)),u};function Dt(a,u){var h=u.type;if(h in a.g){var g=a.g[h],S=Array.prototype.indexOf.call(g,u,void 0),R;(R=0<=S)&&Array.prototype.splice.call(g,S,1),R&&(xn(u),a.g[h].length==0&&(delete a.g[h],a.h--))}}function _t(a,u,h,g){for(var S=0;S<a.length;++S){var R=a[S];if(!R.da&&R.listener==u&&R.capture==!!h&&R.ha==g)return S}return-1}var Zn="closure_lm_"+(1e6*Math.random()|0),Yn={};function us(a,u,h,g,S){if(Array.isArray(u)){for(var R=0;R<u.length;R++)us(a,u[R],h,g,S);return null}return h=Xl(h),a&&a[An]?a.K(u,h,d(g)?!!g.capture:!1,S):ca(a,u,h,!1,g,S)}function ca(a,u,h,g,S,R){if(!u)throw Error("Invalid event type");var L=d(S)?!!S.capture:!!S,pe=ua(a);if(pe||(a[Zn]=pe=new Pt(a)),h=pe.add(u,h,g,L,R),h.proxy)return h;if(g=Sg(),h.proxy=g,g.src=a,g.listener=h,a.addEventListener)$r||(S=L),S===void 0&&(S=!1),a.addEventListener(u.toString(),g,S);else if(a.attachEvent)a.attachEvent(Yl(u.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return h}function Sg(){function a(h){return u.call(a.src,a.listener,h)}const u=Cg;return a}function Zl(a,u,h,g,S){if(Array.isArray(u))for(var R=0;R<u.length;R++)Zl(a,u[R],h,g,S);else g=d(g)?!!g.capture:!!g,h=Xl(h),a&&a[An]?(a=a.i,u=String(u).toString(),u in a.g&&(R=a.g[u],h=_t(R,h,g,S),-1<h&&(xn(R[h]),Array.prototype.splice.call(R,h,1),R.length==0&&(delete a.g[u],a.h--)))):a&&(a=ua(a))&&(u=a.g[u.toString()],a=-1,u&&(a=_t(u,h,g,S)),(h=-1<a?u[a]:null)&&la(h))}function la(a){if(typeof a!="number"&&a&&!a.da){var u=a.src;if(u&&u[An])Dt(u.i,a);else{var h=a.type,g=a.proxy;u.removeEventListener?u.removeEventListener(h,g,a.capture):u.detachEvent?u.detachEvent(Yl(h),g):u.addListener&&u.removeListener&&u.removeListener(g),(h=ua(u))?(Dt(h,a),h.h==0&&(h.src=null,u[Zn]=null)):xn(a)}}}function Yl(a){return a in Yn?Yn[a]:Yn[a]="on"+a}function Cg(a,u){if(a.da)a=!0;else{u=new Kn(u,this);var h=a.listener,g=a.ha||a.src;a.fa&&la(a),a=h.call(g,u)}return a}function ua(a){return a=a[Zn],a instanceof Pt?a:null}var da="__closure_events_fn_"+(1e9*Math.random()>>>0);function Xl(a){return typeof a=="function"?a:(a[da]||(a[da]=function(u){return a.handleEvent(u)}),a[da])}function Fe(){dt.call(this),this.i=new Pt(this),this.M=this,this.F=null}C(Fe,dt),Fe.prototype[An]=!0,Fe.prototype.removeEventListener=function(a,u,h,g){Zl(this,a,u,h,g)};function Ge(a,u){var h,g=a.F;if(g)for(h=[];g;g=g.F)h.push(g);if(a=a.M,g=u.type||u,typeof u=="string")u=new xe(u,a);else if(u instanceof xe)u.target=u.target||a;else{var S=u;u=new xe(g,a),T(u,S)}if(S=!0,h)for(var R=h.length-1;0<=R;R--){var L=u.g=h[R];S=ds(L,g,!0,u)&&S}if(L=u.g=a,S=ds(L,g,!0,u)&&S,S=ds(L,g,!1,u)&&S,h)for(R=0;R<h.length;R++)L=u.g=h[R],S=ds(L,g,!1,u)&&S}Fe.prototype.N=function(){if(Fe.aa.N.call(this),this.i){var a=this.i,u;for(u in a.g){for(var h=a.g[u],g=0;g<h.length;g++)xn(h[g]);delete a.g[u],a.h--}}this.F=null},Fe.prototype.K=function(a,u,h,g){return this.i.add(String(a),u,!1,h,g)},Fe.prototype.L=function(a,u,h,g){return this.i.add(String(a),u,!0,h,g)};function ds(a,u,h,g){if(u=a.i.g[String(u)],!u)return!0;u=u.concat();for(var S=!0,R=0;R<u.length;++R){var L=u[R];if(L&&!L.da&&L.capture==h){var pe=L.listener,Pe=L.ha||L.src;L.fa&&Dt(a.i,L),S=pe.call(Pe,g)!==!1&&S}}return S&&!g.defaultPrevented}function Ql(a,u,h){if(typeof a=="function")h&&(a=m(a,h));else if(a&&typeof a.handleEvent=="function")a=m(a.handleEvent,a);else throw Error("Invalid listener argument");return 2147483647<Number(u)?-1:c.setTimeout(a,u||0)}function Jl(a){a.g=Ql(()=>{a.g=null,a.i&&(a.i=!1,Jl(a))},a.l);const u=a.h;a.h=null,a.m.apply(null,u)}class Rg extends dt{constructor(u,h){super(),this.m=u,this.l=h,this.h=null,this.i=!1,this.g=null}j(u){this.h=arguments,this.g?this.i=!0:Jl(this)}N(){super.N(),this.g&&(c.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function jr(a){dt.call(this),this.h=a,this.g={}}C(jr,dt);var eu=[];function tu(a){ie(a.g,function(u,h){this.g.hasOwnProperty(h)&&la(u)},a),a.g={}}jr.prototype.N=function(){jr.aa.N.call(this),tu(this)},jr.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var ha=c.JSON.stringify,Pg=c.JSON.parse,Dg=class{stringify(a){return c.JSON.stringify(a,void 0)}parse(a){return c.JSON.parse(a,void 0)}};function fa(){}fa.prototype.h=null;function nu(a){return a.h||(a.h=a.i())}function ru(){}var zr={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function pa(){xe.call(this,"d")}C(pa,xe);function ma(){xe.call(this,"c")}C(ma,xe);var kn={},iu=null;function hs(){return iu=iu||new Fe}kn.La="serverreachability";function su(a){xe.call(this,kn.La,a)}C(su,xe);function qr(a){const u=hs();Ge(u,new su(u))}kn.STAT_EVENT="statevent";function ou(a,u){xe.call(this,kn.STAT_EVENT,a),this.stat=u}C(ou,xe);function Ke(a){const u=hs();Ge(u,new ou(u,a))}kn.Ma="timingevent";function au(a,u){xe.call(this,kn.Ma,a),this.size=u}C(au,xe);function Hr(a,u){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return c.setTimeout(function(){a()},u)}function Wr(){this.g=!0}Wr.prototype.xa=function(){this.g=!1};function Ng(a,u,h,g,S,R){a.info(function(){if(a.g)if(R)for(var L="",pe=R.split("&"),Pe=0;Pe<pe.length;Pe++){var le=pe[Pe].split("=");if(1<le.length){var Be=le[0];le=le[1];var Ue=Be.split("_");L=2<=Ue.length&&Ue[1]=="type"?L+(Be+"="+le+"&"):L+(Be+"=redacted&")}}else L=null;else L=R;return"XMLHTTP REQ ("+g+") [attempt "+S+"]: "+u+`
`+h+`
`+L})}function Og(a,u,h,g,S,R,L){a.info(function(){return"XMLHTTP RESP ("+g+") [ attempt "+S+"]: "+u+`
`+h+`
`+R+" "+L})}function Xn(a,u,h,g){a.info(function(){return"XMLHTTP TEXT ("+u+"): "+Lg(a,h)+(g?" "+g:"")})}function Vg(a,u){a.info(function(){return"TIMEOUT: "+u})}Wr.prototype.info=function(){};function Lg(a,u){if(!a.g)return u;if(!u)return null;try{var h=JSON.parse(u);if(h){for(a=0;a<h.length;a++)if(Array.isArray(h[a])){var g=h[a];if(!(2>g.length)){var S=g[1];if(Array.isArray(S)&&!(1>S.length)){var R=S[0];if(R!="noop"&&R!="stop"&&R!="close")for(var L=1;L<S.length;L++)S[L]=""}}}}return ha(h)}catch{return u}}var fs={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},cu={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},ga;function ps(){}C(ps,fa),ps.prototype.g=function(){return new XMLHttpRequest},ps.prototype.i=function(){return{}},ga=new ps;function Gt(a,u,h,g){this.j=a,this.i=u,this.l=h,this.R=g||1,this.U=new jr(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new lu}function lu(){this.i=null,this.g="",this.h=!1}var uu={},ya={};function va(a,u,h){a.L=1,a.v=vs(Nt(u)),a.m=h,a.P=!0,du(a,null)}function du(a,u){a.F=Date.now(),ms(a),a.A=Nt(a.v);var h=a.A,g=a.R;Array.isArray(g)||(g=[String(g)]),Au(h.i,"t",g),a.C=0,h=a.j.J,a.h=new lu,a.g=zu(a.j,h?u:null,!a.m),0<a.O&&(a.M=new Rg(m(a.Y,a,a.g),a.O)),u=a.U,h=a.g,g=a.ca;var S="readystatechange";Array.isArray(S)||(S&&(eu[0]=S.toString()),S=eu);for(var R=0;R<S.length;R++){var L=us(h,S[R],g||u.handleEvent,!1,u.h||u);if(!L)break;u.g[L.key]=L}u=a.H?v(a.H):{},a.m?(a.u||(a.u="POST"),u["Content-Type"]="application/x-www-form-urlencoded",a.g.ea(a.A,a.u,a.m,u)):(a.u="GET",a.g.ea(a.A,a.u,null,u)),qr(),Ng(a.i,a.u,a.A,a.l,a.R,a.m)}Gt.prototype.ca=function(a){a=a.target;const u=this.M;u&&Ot(a)==3?u.j():this.Y(a)},Gt.prototype.Y=function(a){try{if(a==this.g)e:{const Ue=Ot(this.g);var u=this.g.Ba();const er=this.g.Z();if(!(3>Ue)&&(Ue!=3||this.g&&(this.h.h||this.g.oa()||Du(this.g)))){this.J||Ue!=4||u==7||(u==8||0>=er?qr(3):qr(2)),_a(this);var h=this.g.Z();this.X=h;t:if(hu(this)){var g=Du(this.g);a="";var S=g.length,R=Ot(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){Sn(this),Gr(this);var L="";break t}this.h.i=new c.TextDecoder}for(u=0;u<S;u++)this.h.h=!0,a+=this.h.i.decode(g[u],{stream:!(R&&u==S-1)});g.length=0,this.h.g+=a,this.C=0,L=this.h.g}else L=this.g.oa();if(this.o=h==200,Og(this.i,this.u,this.A,this.l,this.R,Ue,h),this.o){if(this.T&&!this.K){t:{if(this.g){var pe,Pe=this.g;if((pe=Pe.g?Pe.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!O(pe)){var le=pe;break t}}le=null}if(h=le)Xn(this.i,this.l,h,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,wa(this,h);else{this.o=!1,this.s=3,Ke(12),Sn(this),Gr(this);break e}}if(this.P){h=!0;let ht;for(;!this.J&&this.C<L.length;)if(ht=Mg(this,L),ht==ya){Ue==4&&(this.s=4,Ke(14),h=!1),Xn(this.i,this.l,null,"[Incomplete Response]");break}else if(ht==uu){this.s=4,Ke(15),Xn(this.i,this.l,L,"[Invalid Chunk]"),h=!1;break}else Xn(this.i,this.l,ht,null),wa(this,ht);if(hu(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),Ue!=4||L.length!=0||this.h.h||(this.s=1,Ke(16),h=!1),this.o=this.o&&h,!h)Xn(this.i,this.l,L,"[Invalid Chunked Response]"),Sn(this),Gr(this);else if(0<L.length&&!this.W){this.W=!0;var Be=this.j;Be.g==this&&Be.ba&&!Be.M&&(Be.j.info("Great, no buffering proxy detected. Bytes received: "+L.length),xa(Be),Be.M=!0,Ke(11))}}else Xn(this.i,this.l,L,null),wa(this,L);Ue==4&&Sn(this),this.o&&!this.J&&(Ue==4?Bu(this.j,this):(this.o=!1,ms(this)))}else ey(this.g),h==400&&0<L.indexOf("Unknown SID")?(this.s=3,Ke(12)):(this.s=0,Ke(13)),Sn(this),Gr(this)}}}catch{}finally{}};function hu(a){return a.g?a.u=="GET"&&a.L!=2&&a.j.Ca:!1}function Mg(a,u){var h=a.C,g=u.indexOf(`
`,h);return g==-1?ya:(h=Number(u.substring(h,g)),isNaN(h)?uu:(g+=1,g+h>u.length?ya:(u=u.slice(g,g+h),a.C=g+h,u)))}Gt.prototype.cancel=function(){this.J=!0,Sn(this)};function ms(a){a.S=Date.now()+a.I,fu(a,a.I)}function fu(a,u){if(a.B!=null)throw Error("WatchDog timer not null");a.B=Hr(m(a.ba,a),u)}function _a(a){a.B&&(c.clearTimeout(a.B),a.B=null)}Gt.prototype.ba=function(){this.B=null;const a=Date.now();0<=a-this.S?(Vg(this.i,this.A),this.L!=2&&(qr(),Ke(17)),Sn(this),this.s=2,Gr(this)):fu(this,this.S-a)};function Gr(a){a.j.G==0||a.J||Bu(a.j,a)}function Sn(a){_a(a);var u=a.M;u&&typeof u.ma=="function"&&u.ma(),a.M=null,tu(a.U),a.g&&(u=a.g,a.g=null,u.abort(),u.ma())}function wa(a,u){try{var h=a.j;if(h.G!=0&&(h.g==a||ba(h.h,a))){if(!a.K&&ba(h.h,a)&&h.G==3){try{var g=h.Da.g.parse(u)}catch{g=null}if(Array.isArray(g)&&g.length==3){var S=g;if(S[0]==0){e:if(!h.u){if(h.g)if(h.g.F+3e3<a.F)Ts(h),Es(h);else break e;Aa(h),Ke(18)}}else h.za=S[1],0<h.za-h.T&&37500>S[2]&&h.F&&h.v==0&&!h.C&&(h.C=Hr(m(h.Za,h),6e3));if(1>=gu(h.h)&&h.ca){try{h.ca()}catch{}h.ca=void 0}}else Rn(h,11)}else if((a.K||h.g==a)&&Ts(h),!O(u))for(S=h.Da.g.parse(u),u=0;u<S.length;u++){let le=S[u];if(h.T=le[0],le=le[1],h.G==2)if(le[0]=="c"){h.K=le[1],h.ia=le[2];const Be=le[3];Be!=null&&(h.la=Be,h.j.info("VER="+h.la));const Ue=le[4];Ue!=null&&(h.Aa=Ue,h.j.info("SVER="+h.Aa));const er=le[5];er!=null&&typeof er=="number"&&0<er&&(g=1.5*er,h.L=g,h.j.info("backChannelRequestTimeoutMs_="+g)),g=h;const ht=a.g;if(ht){const xs=ht.g?ht.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(xs){var R=g.h;R.g||xs.indexOf("spdy")==-1&&xs.indexOf("quic")==-1&&xs.indexOf("h2")==-1||(R.j=R.l,R.g=new Set,R.h&&(Ea(R,R.h),R.h=null))}if(g.D){const ka=ht.g?ht.g.getResponseHeader("X-HTTP-Session-Id"):null;ka&&(g.ya=ka,ge(g.I,g.D,ka))}}h.G=3,h.l&&h.l.ua(),h.ba&&(h.R=Date.now()-a.F,h.j.info("Handshake RTT: "+h.R+"ms")),g=h;var L=a;if(g.qa=ju(g,g.J?g.ia:null,g.W),L.K){yu(g.h,L);var pe=L,Pe=g.L;Pe&&(pe.I=Pe),pe.B&&(_a(pe),ms(pe)),g.g=L}else Mu(g);0<h.i.length&&Is(h)}else le[0]!="stop"&&le[0]!="close"||Rn(h,7);else h.G==3&&(le[0]=="stop"||le[0]=="close"?le[0]=="stop"?Rn(h,7):Ta(h):le[0]!="noop"&&h.l&&h.l.ta(le),h.v=0)}}qr(4)}catch{}}var Fg=class{constructor(a,u){this.g=a,this.map=u}};function pu(a){this.l=a||10,c.PerformanceNavigationTiming?(a=c.performance.getEntriesByType("navigation"),a=0<a.length&&(a[0].nextHopProtocol=="hq"||a[0].nextHopProtocol=="h2")):a=!!(c.chrome&&c.chrome.loadTimes&&c.chrome.loadTimes()&&c.chrome.loadTimes().wasFetchedViaSpdy),this.j=a?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function mu(a){return a.h?!0:a.g?a.g.size>=a.j:!1}function gu(a){return a.h?1:a.g?a.g.size:0}function ba(a,u){return a.h?a.h==u:a.g?a.g.has(u):!1}function Ea(a,u){a.g?a.g.add(u):a.h=u}function yu(a,u){a.h&&a.h==u?a.h=null:a.g&&a.g.has(u)&&a.g.delete(u)}pu.prototype.cancel=function(){if(this.i=vu(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(const a of this.g.values())a.cancel();this.g.clear()}};function vu(a){if(a.h!=null)return a.i.concat(a.h.D);if(a.g!=null&&a.g.size!==0){let u=a.i;for(const h of a.g.values())u=u.concat(h.D);return u}return x(a.i)}function Bg(a){if(a.V&&typeof a.V=="function")return a.V();if(typeof Map<"u"&&a instanceof Map||typeof Set<"u"&&a instanceof Set)return Array.from(a.values());if(typeof a=="string")return a.split("");if(l(a)){for(var u=[],h=a.length,g=0;g<h;g++)u.push(a[g]);return u}u=[],h=0;for(g in a)u[h++]=a[g];return u}function Ug(a){if(a.na&&typeof a.na=="function")return a.na();if(!a.V||typeof a.V!="function"){if(typeof Map<"u"&&a instanceof Map)return Array.from(a.keys());if(!(typeof Set<"u"&&a instanceof Set)){if(l(a)||typeof a=="string"){var u=[];a=a.length;for(var h=0;h<a;h++)u.push(h);return u}u=[],h=0;for(const g in a)u[h++]=g;return u}}}function _u(a,u){if(a.forEach&&typeof a.forEach=="function")a.forEach(u,void 0);else if(l(a)||typeof a=="string")Array.prototype.forEach.call(a,u,void 0);else for(var h=Ug(a),g=Bg(a),S=g.length,R=0;R<S;R++)u.call(void 0,g[R],h&&h[R],a)}var wu=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function $g(a,u){if(a){a=a.split("&");for(var h=0;h<a.length;h++){var g=a[h].indexOf("="),S=null;if(0<=g){var R=a[h].substring(0,g);S=a[h].substring(g+1)}else R=a[h];u(R,S?decodeURIComponent(S.replace(/\+/g," ")):"")}}}function Cn(a){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,a instanceof Cn){this.h=a.h,gs(this,a.j),this.o=a.o,this.g=a.g,ys(this,a.s),this.l=a.l;var u=a.i,h=new Yr;h.i=u.i,u.g&&(h.g=new Map(u.g),h.h=u.h),bu(this,h),this.m=a.m}else a&&(u=String(a).match(wu))?(this.h=!1,gs(this,u[1]||"",!0),this.o=Kr(u[2]||""),this.g=Kr(u[3]||"",!0),ys(this,u[4]),this.l=Kr(u[5]||"",!0),bu(this,u[6]||"",!0),this.m=Kr(u[7]||"")):(this.h=!1,this.i=new Yr(null,this.h))}Cn.prototype.toString=function(){var a=[],u=this.j;u&&a.push(Zr(u,Eu,!0),":");var h=this.g;return(h||u=="file")&&(a.push("//"),(u=this.o)&&a.push(Zr(u,Eu,!0),"@"),a.push(encodeURIComponent(String(h)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),h=this.s,h!=null&&a.push(":",String(h))),(h=this.l)&&(this.g&&h.charAt(0)!="/"&&a.push("/"),a.push(Zr(h,h.charAt(0)=="/"?qg:zg,!0))),(h=this.i.toString())&&a.push("?",h),(h=this.m)&&a.push("#",Zr(h,Wg)),a.join("")};function Nt(a){return new Cn(a)}function gs(a,u,h){a.j=h?Kr(u,!0):u,a.j&&(a.j=a.j.replace(/:$/,""))}function ys(a,u){if(u){if(u=Number(u),isNaN(u)||0>u)throw Error("Bad port number "+u);a.s=u}else a.s=null}function bu(a,u,h){u instanceof Yr?(a.i=u,Gg(a.i,a.h)):(h||(u=Zr(u,Hg)),a.i=new Yr(u,a.h))}function ge(a,u,h){a.i.set(u,h)}function vs(a){return ge(a,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),a}function Kr(a,u){return a?u?decodeURI(a.replace(/%25/g,"%2525")):decodeURIComponent(a):""}function Zr(a,u,h){return typeof a=="string"?(a=encodeURI(a).replace(u,jg),h&&(a=a.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),a):null}function jg(a){return a=a.charCodeAt(0),"%"+(a>>4&15).toString(16)+(a&15).toString(16)}var Eu=/[#\/\?@]/g,zg=/[#\?:]/g,qg=/[#\?]/g,Hg=/[#\?@]/g,Wg=/#/g;function Yr(a,u){this.h=this.g=null,this.i=a||null,this.j=!!u}function Kt(a){a.g||(a.g=new Map,a.h=0,a.i&&$g(a.i,function(u,h){a.add(decodeURIComponent(u.replace(/\+/g," ")),h)}))}n=Yr.prototype,n.add=function(a,u){Kt(this),this.i=null,a=Qn(this,a);var h=this.g.get(a);return h||this.g.set(a,h=[]),h.push(u),this.h+=1,this};function Iu(a,u){Kt(a),u=Qn(a,u),a.g.has(u)&&(a.i=null,a.h-=a.g.get(u).length,a.g.delete(u))}function Tu(a,u){return Kt(a),u=Qn(a,u),a.g.has(u)}n.forEach=function(a,u){Kt(this),this.g.forEach(function(h,g){h.forEach(function(S){a.call(u,S,g,this)},this)},this)},n.na=function(){Kt(this);const a=Array.from(this.g.values()),u=Array.from(this.g.keys()),h=[];for(let g=0;g<u.length;g++){const S=a[g];for(let R=0;R<S.length;R++)h.push(u[g])}return h},n.V=function(a){Kt(this);let u=[];if(typeof a=="string")Tu(this,a)&&(u=u.concat(this.g.get(Qn(this,a))));else{a=Array.from(this.g.values());for(let h=0;h<a.length;h++)u=u.concat(a[h])}return u},n.set=function(a,u){return Kt(this),this.i=null,a=Qn(this,a),Tu(this,a)&&(this.h-=this.g.get(a).length),this.g.set(a,[u]),this.h+=1,this},n.get=function(a,u){return a?(a=this.V(a),0<a.length?String(a[0]):u):u};function Au(a,u,h){Iu(a,u),0<h.length&&(a.i=null,a.g.set(Qn(a,u),x(h)),a.h+=h.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";const a=[],u=Array.from(this.g.keys());for(var h=0;h<u.length;h++){var g=u[h];const R=encodeURIComponent(String(g)),L=this.V(g);for(g=0;g<L.length;g++){var S=R;L[g]!==""&&(S+="="+encodeURIComponent(String(L[g]))),a.push(S)}}return this.i=a.join("&")};function Qn(a,u){return u=String(u),a.j&&(u=u.toLowerCase()),u}function Gg(a,u){u&&!a.j&&(Kt(a),a.i=null,a.g.forEach(function(h,g){var S=g.toLowerCase();g!=S&&(Iu(this,g),Au(this,S,h))},a)),a.j=u}function Kg(a,u){const h=new Wr;if(c.Image){const g=new Image;g.onload=_(Zt,h,"TestLoadImage: loaded",!0,u,g),g.onerror=_(Zt,h,"TestLoadImage: error",!1,u,g),g.onabort=_(Zt,h,"TestLoadImage: abort",!1,u,g),g.ontimeout=_(Zt,h,"TestLoadImage: timeout",!1,u,g),c.setTimeout(function(){g.ontimeout&&g.ontimeout()},1e4),g.src=a}else u(!1)}function Zg(a,u){const h=new Wr,g=new AbortController,S=setTimeout(()=>{g.abort(),Zt(h,"TestPingServer: timeout",!1,u)},1e4);fetch(a,{signal:g.signal}).then(R=>{clearTimeout(S),R.ok?Zt(h,"TestPingServer: ok",!0,u):Zt(h,"TestPingServer: server error",!1,u)}).catch(()=>{clearTimeout(S),Zt(h,"TestPingServer: error",!1,u)})}function Zt(a,u,h,g,S){try{S&&(S.onload=null,S.onerror=null,S.onabort=null,S.ontimeout=null),g(h)}catch{}}function Yg(){this.g=new Dg}function Xg(a,u,h){const g=h||"";try{_u(a,function(S,R){let L=S;d(S)&&(L=ha(S)),u.push(g+R+"="+encodeURIComponent(L))})}catch(S){throw u.push(g+"type="+encodeURIComponent("_badmap")),S}}function _s(a){this.l=a.Ub||null,this.j=a.eb||!1}C(_s,fa),_s.prototype.g=function(){return new ws(this.l,this.j)},_s.prototype.i=(function(a){return function(){return a}})({});function ws(a,u){Fe.call(this),this.D=a,this.o=u,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}C(ws,Fe),n=ws.prototype,n.open=function(a,u){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=a,this.A=u,this.readyState=1,Qr(this)},n.send=function(a){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;const u={headers:this.u,method:this.B,credentials:this.m,cache:void 0};a&&(u.body=a),(this.D||c).fetch(new Request(this.A,u)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Xr(this)),this.readyState=0},n.Sa=function(a){if(this.g&&(this.l=a,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=a.headers,this.readyState=2,Qr(this)),this.g&&(this.readyState=3,Qr(this),this.g)))if(this.responseType==="arraybuffer")a.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof c.ReadableStream<"u"&&"body"in a){if(this.j=a.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;xu(this)}else a.text().then(this.Ra.bind(this),this.ga.bind(this))};function xu(a){a.j.read().then(a.Pa.bind(a)).catch(a.ga.bind(a))}n.Pa=function(a){if(this.g){if(this.o&&a.value)this.response.push(a.value);else if(!this.o){var u=a.value?a.value:new Uint8Array(0);(u=this.v.decode(u,{stream:!a.done}))&&(this.response=this.responseText+=u)}a.done?Xr(this):Qr(this),this.readyState==3&&xu(this)}},n.Ra=function(a){this.g&&(this.response=this.responseText=a,Xr(this))},n.Qa=function(a){this.g&&(this.response=a,Xr(this))},n.ga=function(){this.g&&Xr(this)};function Xr(a){a.readyState=4,a.l=null,a.j=null,a.v=null,Qr(a)}n.setRequestHeader=function(a,u){this.u.append(a,u)},n.getResponseHeader=function(a){return this.h&&this.h.get(a.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";const a=[],u=this.h.entries();for(var h=u.next();!h.done;)h=h.value,a.push(h[0]+": "+h[1]),h=u.next();return a.join(`\r
`)};function Qr(a){a.onreadystatechange&&a.onreadystatechange.call(a)}Object.defineProperty(ws.prototype,"withCredentials",{get:function(){return this.m==="include"},set:function(a){this.m=a?"include":"same-origin"}});function ku(a){let u="";return ie(a,function(h,g){u+=g,u+=":",u+=h,u+=`\r
`}),u}function Ia(a,u,h){e:{for(g in h){var g=!1;break e}g=!0}g||(h=ku(h),typeof a=="string"?h!=null&&encodeURIComponent(String(h)):ge(a,u,h))}function we(a){Fe.call(this),this.headers=new Map,this.o=a||null,this.h=!1,this.v=this.g=null,this.D="",this.m=0,this.l="",this.j=this.B=this.u=this.A=!1,this.I=null,this.H="",this.J=!1}C(we,Fe);var Qg=/^https?$/i,Jg=["POST","PUT"];n=we.prototype,n.Ha=function(a){this.J=a},n.ea=function(a,u,h,g){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.D+"; newUri="+a);u=u?u.toUpperCase():"GET",this.D=a,this.l="",this.m=0,this.A=!1,this.h=!0,this.g=this.o?this.o.g():ga.g(),this.v=this.o?nu(this.o):nu(ga),this.g.onreadystatechange=m(this.Ea,this);try{this.B=!0,this.g.open(u,String(a),!0),this.B=!1}catch(R){Su(this,R);return}if(a=h||"",h=new Map(this.headers),g)if(Object.getPrototypeOf(g)===Object.prototype)for(var S in g)h.set(S,g[S]);else if(typeof g.keys=="function"&&typeof g.get=="function")for(const R of g.keys())h.set(R,g.get(R));else throw Error("Unknown input type for opt_headers: "+String(g));g=Array.from(h.keys()).find(R=>R.toLowerCase()=="content-type"),S=c.FormData&&a instanceof c.FormData,!(0<=Array.prototype.indexOf.call(Jg,u,void 0))||g||S||h.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8");for(const[R,L]of h)this.g.setRequestHeader(R,L);this.H&&(this.g.responseType=this.H),"withCredentials"in this.g&&this.g.withCredentials!==this.J&&(this.g.withCredentials=this.J);try{Pu(this),this.u=!0,this.g.send(a),this.u=!1}catch(R){Su(this,R)}};function Su(a,u){a.h=!1,a.g&&(a.j=!0,a.g.abort(),a.j=!1),a.l=u,a.m=5,Cu(a),bs(a)}function Cu(a){a.A||(a.A=!0,Ge(a,"complete"),Ge(a,"error"))}n.abort=function(a){this.g&&this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1,this.m=a||7,Ge(this,"complete"),Ge(this,"abort"),bs(this))},n.N=function(){this.g&&(this.h&&(this.h=!1,this.j=!0,this.g.abort(),this.j=!1),bs(this,!0)),we.aa.N.call(this)},n.Ea=function(){this.s||(this.B||this.u||this.j?Ru(this):this.bb())},n.bb=function(){Ru(this)};function Ru(a){if(a.h&&typeof o<"u"&&(!a.v[1]||Ot(a)!=4||a.Z()!=2)){if(a.u&&Ot(a)==4)Ql(a.Ea,0,a);else if(Ge(a,"readystatechange"),Ot(a)==4){a.h=!1;try{const L=a.Z();e:switch(L){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var u=!0;break e;default:u=!1}var h;if(!(h=u)){var g;if(g=L===0){var S=String(a.D).match(wu)[1]||null;!S&&c.self&&c.self.location&&(S=c.self.location.protocol.slice(0,-1)),g=!Qg.test(S?S.toLowerCase():"")}h=g}if(h)Ge(a,"complete"),Ge(a,"success");else{a.m=6;try{var R=2<Ot(a)?a.g.statusText:""}catch{R=""}a.l=R+" ["+a.Z()+"]",Cu(a)}}finally{bs(a)}}}}function bs(a,u){if(a.g){Pu(a);const h=a.g,g=a.v[0]?()=>{}:null;a.g=null,a.v=null,u||Ge(a,"ready");try{h.onreadystatechange=g}catch{}}}function Pu(a){a.I&&(c.clearTimeout(a.I),a.I=null)}n.isActive=function(){return!!this.g};function Ot(a){return a.g?a.g.readyState:0}n.Z=function(){try{return 2<Ot(this)?this.g.status:-1}catch{return-1}},n.oa=function(){try{return this.g?this.g.responseText:""}catch{return""}},n.Oa=function(a){if(this.g){var u=this.g.responseText;return a&&u.indexOf(a)==0&&(u=u.substring(a.length)),Pg(u)}};function Du(a){try{if(!a.g)return null;if("response"in a.g)return a.g.response;switch(a.H){case"":case"text":return a.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in a.g)return a.g.mozResponseArrayBuffer}return null}catch{return null}}function ey(a){const u={};a=(a.g&&2<=Ot(a)&&a.g.getAllResponseHeaders()||"").split(`\r
`);for(let g=0;g<a.length;g++){if(O(a[g]))continue;var h=b(a[g]);const S=h[0];if(h=h[1],typeof h!="string")continue;h=h.trim();const R=u[S]||[];u[S]=R,R.push(h)}I(u,function(g){return g.join(", ")})}n.Ba=function(){return this.m},n.Ka=function(){return typeof this.l=="string"?this.l:String(this.l)};function Jr(a,u,h){return h&&h.internalChannelParams&&h.internalChannelParams[a]||u}function Nu(a){this.Aa=0,this.i=[],this.j=new Wr,this.ia=this.qa=this.I=this.W=this.g=this.ya=this.D=this.H=this.m=this.S=this.o=null,this.Ya=this.U=0,this.Va=Jr("failFast",!1,a),this.F=this.C=this.u=this.s=this.l=null,this.X=!0,this.za=this.T=-1,this.Y=this.v=this.B=0,this.Ta=Jr("baseRetryDelayMs",5e3,a),this.cb=Jr("retryDelaySeedMs",1e4,a),this.Wa=Jr("forwardChannelMaxRetries",2,a),this.wa=Jr("forwardChannelRequestTimeoutMs",2e4,a),this.pa=a&&a.xmlHttpFactory||void 0,this.Xa=a&&a.Tb||void 0,this.Ca=a&&a.useFetchStreams||!1,this.L=void 0,this.J=a&&a.supportsCrossDomainXhr||!1,this.K="",this.h=new pu(a&&a.concurrentRequestLimit),this.Da=new Yg,this.P=a&&a.fastHandshake||!1,this.O=a&&a.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.Ua=a&&a.Rb||!1,a&&a.xa&&this.j.xa(),a&&a.forceLongPolling&&(this.X=!1),this.ba=!this.P&&this.X&&a&&a.detectBufferingProxy||!1,this.ja=void 0,a&&a.longPollingTimeout&&0<a.longPollingTimeout&&(this.ja=a.longPollingTimeout),this.ca=void 0,this.R=0,this.M=!1,this.ka=this.A=null}n=Nu.prototype,n.la=8,n.G=1,n.connect=function(a,u,h,g){Ke(0),this.W=a,this.H=u||{},h&&g!==void 0&&(this.H.OSID=h,this.H.OAID=g),this.F=this.X,this.I=ju(this,null,this.W),Is(this)};function Ta(a){if(Ou(a),a.G==3){var u=a.U++,h=Nt(a.I);if(ge(h,"SID",a.K),ge(h,"RID",u),ge(h,"TYPE","terminate"),ei(a,h),u=new Gt(a,a.j,u),u.L=2,u.v=vs(Nt(h)),h=!1,c.navigator&&c.navigator.sendBeacon)try{h=c.navigator.sendBeacon(u.v.toString(),"")}catch{}!h&&c.Image&&(new Image().src=u.v,h=!0),h||(u.g=zu(u.j,null),u.g.ea(u.v)),u.F=Date.now(),ms(u)}$u(a)}function Es(a){a.g&&(xa(a),a.g.cancel(),a.g=null)}function Ou(a){Es(a),a.u&&(c.clearTimeout(a.u),a.u=null),Ts(a),a.h.cancel(),a.s&&(typeof a.s=="number"&&c.clearTimeout(a.s),a.s=null)}function Is(a){if(!mu(a.h)&&!a.s){a.s=!0;var u=a.Ga;In||Tn(),Wn||(In(),Wn=!0),Ur.add(u,a),a.B=0}}function ty(a,u){return gu(a.h)>=a.h.j-(a.s?1:0)?!1:a.s?(a.i=u.D.concat(a.i),!0):a.G==1||a.G==2||a.B>=(a.Va?0:a.Wa)?!1:(a.s=Hr(m(a.Ga,a,u),Uu(a,a.B)),a.B++,!0)}n.Ga=function(a){if(this.s)if(this.s=null,this.G==1){if(!a){this.U=Math.floor(1e5*Math.random()),a=this.U++;const S=new Gt(this,this.j,a);let R=this.o;if(this.S&&(R?(R=v(R),T(R,this.S)):R=this.S),this.m!==null||this.O||(S.H=R,R=null),this.P)e:{for(var u=0,h=0;h<this.i.length;h++){t:{var g=this.i[h];if("__data__"in g.map&&(g=g.map.__data__,typeof g=="string")){g=g.length;break t}g=void 0}if(g===void 0)break;if(u+=g,4096<u){u=h;break e}if(u===4096||h===this.i.length-1){u=h+1;break e}}u=1e3}else u=1e3;u=Lu(this,S,u),h=Nt(this.I),ge(h,"RID",a),ge(h,"CVER",22),this.D&&ge(h,"X-HTTP-Session-Id",this.D),ei(this,h),R&&(this.O?u="headers="+encodeURIComponent(String(ku(R)))+"&"+u:this.m&&Ia(h,this.m,R)),Ea(this.h,S),this.Ua&&ge(h,"TYPE","init"),this.P?(ge(h,"$req",u),ge(h,"SID","null"),S.T=!0,va(S,h,null)):va(S,h,u),this.G=2}}else this.G==3&&(a?Vu(this,a):this.i.length==0||mu(this.h)||Vu(this))};function Vu(a,u){var h;u?h=u.l:h=a.U++;const g=Nt(a.I);ge(g,"SID",a.K),ge(g,"RID",h),ge(g,"AID",a.T),ei(a,g),a.m&&a.o&&Ia(g,a.m,a.o),h=new Gt(a,a.j,h,a.B+1),a.m===null&&(h.H=a.o),u&&(a.i=u.D.concat(a.i)),u=Lu(a,h,1e3),h.I=Math.round(.5*a.wa)+Math.round(.5*a.wa*Math.random()),Ea(a.h,h),va(h,g,u)}function ei(a,u){a.H&&ie(a.H,function(h,g){ge(u,g,h)}),a.l&&_u({},function(h,g){ge(u,g,h)})}function Lu(a,u,h){h=Math.min(a.i.length,h);var g=a.l?m(a.l.Na,a.l,a):null;e:{var S=a.i;let R=-1;for(;;){const L=["count="+h];R==-1?0<h?(R=S[0].g,L.push("ofs="+R)):R=0:L.push("ofs="+R);let pe=!0;for(let Pe=0;Pe<h;Pe++){let le=S[Pe].g;const Be=S[Pe].map;if(le-=R,0>le)R=Math.max(0,S[Pe].g-100),pe=!1;else try{Xg(Be,L,"req"+le+"_")}catch{g&&g(Be)}}if(pe){g=L.join("&");break e}}}return a=a.i.splice(0,h),u.D=a,g}function Mu(a){if(!a.g&&!a.u){a.Y=1;var u=a.Fa;In||Tn(),Wn||(In(),Wn=!0),Ur.add(u,a),a.v=0}}function Aa(a){return a.g||a.u||3<=a.v?!1:(a.Y++,a.u=Hr(m(a.Fa,a),Uu(a,a.v)),a.v++,!0)}n.Fa=function(){if(this.u=null,Fu(this),this.ba&&!(this.M||this.g==null||0>=this.R)){var a=2*this.R;this.j.info("BP detection timer enabled: "+a),this.A=Hr(m(this.ab,this),a)}},n.ab=function(){this.A&&(this.A=null,this.j.info("BP detection timeout reached."),this.j.info("Buffering proxy detected and switch to long-polling!"),this.F=!1,this.M=!0,Ke(10),Es(this),Fu(this))};function xa(a){a.A!=null&&(c.clearTimeout(a.A),a.A=null)}function Fu(a){a.g=new Gt(a,a.j,"rpc",a.Y),a.m===null&&(a.g.H=a.o),a.g.O=0;var u=Nt(a.qa);ge(u,"RID","rpc"),ge(u,"SID",a.K),ge(u,"AID",a.T),ge(u,"CI",a.F?"0":"1"),!a.F&&a.ja&&ge(u,"TO",a.ja),ge(u,"TYPE","xmlhttp"),ei(a,u),a.m&&a.o&&Ia(u,a.m,a.o),a.L&&(a.g.I=a.L);var h=a.g;a=a.ia,h.L=1,h.v=vs(Nt(u)),h.m=null,h.P=!0,du(h,a)}n.Za=function(){this.C!=null&&(this.C=null,Es(this),Aa(this),Ke(19))};function Ts(a){a.C!=null&&(c.clearTimeout(a.C),a.C=null)}function Bu(a,u){var h=null;if(a.g==u){Ts(a),xa(a),a.g=null;var g=2}else if(ba(a.h,u))h=u.D,yu(a.h,u),g=1;else return;if(a.G!=0){if(u.o)if(g==1){h=u.m?u.m.length:0,u=Date.now()-u.F;var S=a.B;g=hs(),Ge(g,new au(g,h)),Is(a)}else Mu(a);else if(S=u.s,S==3||S==0&&0<u.X||!(g==1&&ty(a,u)||g==2&&Aa(a)))switch(h&&0<h.length&&(u=a.h,u.i=u.i.concat(h)),S){case 1:Rn(a,5);break;case 4:Rn(a,10);break;case 3:Rn(a,6);break;default:Rn(a,2)}}}function Uu(a,u){let h=a.Ta+Math.floor(Math.random()*a.cb);return a.isActive()||(h*=2),h*u}function Rn(a,u){if(a.j.info("Error code "+u),u==2){var h=m(a.fb,a),g=a.Xa;const S=!g;g=new Cn(g||"//www.google.com/images/cleardot.gif"),c.location&&c.location.protocol=="http"||gs(g,"https"),vs(g),S?Kg(g.toString(),h):Zg(g.toString(),h)}else Ke(2);a.G=0,a.l&&a.l.sa(u),$u(a),Ou(a)}n.fb=function(a){a?(this.j.info("Successfully pinged google.com"),Ke(2)):(this.j.info("Failed to ping google.com"),Ke(1))};function $u(a){if(a.G=0,a.ka=[],a.l){const u=vu(a.h);(u.length!=0||a.i.length!=0)&&(A(a.ka,u),A(a.ka,a.i),a.h.i.length=0,x(a.i),a.i.length=0),a.l.ra()}}function ju(a,u,h){var g=h instanceof Cn?Nt(h):new Cn(h);if(g.g!="")u&&(g.g=u+"."+g.g),ys(g,g.s);else{var S=c.location;g=S.protocol,u=u?u+"."+S.hostname:S.hostname,S=+S.port;var R=new Cn(null);g&&gs(R,g),u&&(R.g=u),S&&ys(R,S),h&&(R.l=h),g=R}return h=a.D,u=a.ya,h&&u&&ge(g,h,u),ge(g,"VER",a.la),ei(a,g),g}function zu(a,u,h){if(u&&!a.J)throw Error("Can't create secondary domain capable XhrIo object.");return u=a.Ca&&!a.pa?new we(new _s({eb:h})):new we(a.pa),u.Ha(a.J),u}n.isActive=function(){return!!this.l&&this.l.isActive(this)};function qu(){}n=qu.prototype,n.ua=function(){},n.ta=function(){},n.sa=function(){},n.ra=function(){},n.isActive=function(){return!0},n.Na=function(){};function As(){}As.prototype.g=function(a,u){return new it(a,u)};function it(a,u){Fe.call(this),this.g=new Nu(u),this.l=a,this.h=u&&u.messageUrlParams||null,a=u&&u.messageHeaders||null,u&&u.clientProtocolHeaderRequired&&(a?a["X-Client-Protocol"]="webchannel":a={"X-Client-Protocol":"webchannel"}),this.g.o=a,a=u&&u.initMessageHeaders||null,u&&u.messageContentType&&(a?a["X-WebChannel-Content-Type"]=u.messageContentType:a={"X-WebChannel-Content-Type":u.messageContentType}),u&&u.va&&(a?a["X-WebChannel-Client-Profile"]=u.va:a={"X-WebChannel-Client-Profile":u.va}),this.g.S=a,(a=u&&u.Sb)&&!O(a)&&(this.g.m=a),this.v=u&&u.supportsCrossDomainXhr||!1,this.u=u&&u.sendRawJson||!1,(u=u&&u.httpSessionIdParam)&&!O(u)&&(this.g.D=u,a=this.h,a!==null&&u in a&&(a=this.h,u in a&&delete a[u])),this.j=new Jn(this)}C(it,Fe),it.prototype.m=function(){this.g.l=this.j,this.v&&(this.g.J=!0),this.g.connect(this.l,this.h||void 0)},it.prototype.close=function(){Ta(this.g)},it.prototype.o=function(a){var u=this.g;if(typeof a=="string"){var h={};h.__data__=a,a=h}else this.u&&(h={},h.__data__=ha(a),a=h);u.i.push(new Fg(u.Ya++,a)),u.G==3&&Is(u)},it.prototype.N=function(){this.g.l=null,delete this.j,Ta(this.g),delete this.g,it.aa.N.call(this)};function Hu(a){pa.call(this),a.__headers__&&(this.headers=a.__headers__,this.statusCode=a.__status__,delete a.__headers__,delete a.__status__);var u=a.__sm__;if(u){e:{for(const h in u){a=h;break e}a=void 0}(this.i=a)&&(a=this.i,u=u!==null&&a in u?u[a]:void 0),this.data=u}else this.data=a}C(Hu,pa);function Wu(){ma.call(this),this.status=1}C(Wu,ma);function Jn(a){this.g=a}C(Jn,qu),Jn.prototype.ua=function(){Ge(this.g,"a")},Jn.prototype.ta=function(a){Ge(this.g,new Hu(a))},Jn.prototype.sa=function(a){Ge(this.g,new Wu)},Jn.prototype.ra=function(){Ge(this.g,"b")},As.prototype.createWebChannel=As.prototype.g,it.prototype.send=it.prototype.o,it.prototype.open=it.prototype.m,it.prototype.close=it.prototype.close,gf=function(){return new As},mf=function(){return hs()},pf=kn,nc={mb:0,pb:1,qb:2,Jb:3,Ob:4,Lb:5,Mb:6,Kb:7,Ib:8,Nb:9,PROXY:10,NOPROXY:11,Gb:12,Cb:13,Db:14,Bb:15,Eb:16,Fb:17,ib:18,hb:19,jb:20},fs.NO_ERROR=0,fs.TIMEOUT=8,fs.HTTP_ERROR=6,Os=fs,cu.COMPLETE="complete",ff=cu,ru.EventType=zr,zr.OPEN="a",zr.CLOSE="b",zr.ERROR="c",zr.MESSAGE="d",Fe.prototype.listen=Fe.prototype.K,ri=ru,we.prototype.listenOnce=we.prototype.L,we.prototype.getLastError=we.prototype.Ka,we.prototype.getLastErrorCode=we.prototype.Ba,we.prototype.getStatus=we.prototype.Z,we.prototype.getResponseJson=we.prototype.Oa,we.prototype.getResponseText=we.prototype.oa,we.prototype.send=we.prototype.ea,we.prototype.setWithCredentials=we.prototype.Ha,hf=we}).apply(typeof ks<"u"?ks:typeof self<"u"?self:typeof window<"u"?window:{});const sd="@firebase/firestore",od="4.8.0";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Fn=new Mc("@firebase/firestore");function rr(){return Fn.logLevel}function $(n,...e){if(Fn.logLevel<=se.DEBUG){const t=e.map(Uc);Fn.debug(`Firestore (${Rr}): ${n}`,...t)}}function $t(n,...e){if(Fn.logLevel<=se.ERROR){const t=e.map(Uc);Fn.error(`Firestore (${Rr}): ${n}`,...t)}}function ln(n,...e){if(Fn.logLevel<=se.WARN){const t=e.map(Uc);Fn.warn(`Firestore (${Rr}): ${n}`,...t)}}function Uc(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jc=-1;function So(n){return n==null}function Ys(n){return n===0&&1/n==-1/0}function r_(n){return typeof n=="number"&&Number.isInteger(n)&&!Ys(n)&&n<=Number.MAX_SAFE_INTEGER&&n>=Number.MIN_SAFE_INTEGER}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Af="server_timestamp",xf="__type__",kf="__previous_value__",Sf="__local_write_time__";function zc(n){var e,t;return((t=(((e=n==null?void 0:n.mapValue)===null||e===void 0?void 0:e.fields)||{})[xf])===null||t===void 0?void 0:t.stringValue)===Af}function Co(n){const e=n.mapValue.fields[kf];return zc(e)?Co(e):e}function bi(n){const e=dn(n.mapValue.fields[Sf].timestampValue);return new ye(e.seconds,e.nanos)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class a_{constructor(e,t,r,i,s,o,c,l,d,f){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=i,this.ssl=s,this.forceLongPolling=o,this.autoDetectLongPolling=c,this.longPollingOptions=l,this.useFetchStreams=d,this.isUsingEmulator=f}}const Xs="(default)";class Ei{constructor(e,t){this.projectId=e,this.database=t||Xs}static empty(){return new Ei("","")}get isDefaultDatabase(){return this.database===Xs}isEqual(e){return e instanceof Ei&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gc(n,e){if(n.useProto3Json){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:Ys(e)?"-0":e}}function qf(n){return{integerValue:""+n}}function R_(n,e){return r_(e)?qf(e):Gc(n,e)}/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class N_{constructor(e,t){this.field=e,this.transform=t}}function O_(n,e){return n.field.isEqual(e.field)&&(function(r,i){return r instanceof xi&&i instanceof xi||r instanceof ki&&i instanceof ki?yr(r.elements,i.elements,St):r instanceof eo&&i instanceof eo?St(r.Ee,i.Ee):r instanceof Ai&&i instanceof Ai})(n.transform,e.transform)}class V_{constructor(e,t){this.version=e,this.transformResults=t}}class Ye{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Ye}static exists(e){return new Ye(void 0,e)}static updateTime(e){return new Ye(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function Ms(n,e){return n.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(n.updateTime):n.exists===void 0||n.exists===e.isFoundDocument()}class Oo{}function Zf(n,e){if(!n.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return n.isNoDocument()?new Vo(n.key,Ye.none()):new Yi(n.key,n.data,Ye.none());{const t=n.data,r=tt.empty();let i=new ke(Le.comparator);for(let s of e.fields)if(!i.has(s)){let o=t.field(s);o===null&&s.length>1&&(s=s.popLast(),o=t.field(s)),o===null?r.delete(s):r.set(s,o),i=i.add(s)}return new wn(n.key,r,new ot(i.toArray()),Ye.none())}}function L_(n,e,t){n instanceof Yi?(function(i,s,o){const c=i.value.clone(),l=Sd(i.fieldTransforms,s,o.transformResults);c.setAll(l),s.convertToFoundDocument(o.version,c).setHasCommittedMutations()})(n,e,t):n instanceof wn?(function(i,s,o){if(!Ms(i.precondition,s))return void s.convertToUnknownDocument(o.version);const c=Sd(i.fieldTransforms,s,o.transformResults),l=s.data;l.setAll(Yf(i)),l.setAll(c),s.convertToFoundDocument(o.version,l).setHasCommittedMutations()})(n,e,t):(function(i,s,o){s.convertToNoDocument(o.version).setHasCommittedMutations()})(0,e,t)}function gi(n,e,t,r){return n instanceof Yi?(function(s,o,c,l){if(!Ms(s.precondition,o))return c;const d=s.value.clone(),f=Cd(s.fieldTransforms,l,o);return d.setAll(f),o.convertToFoundDocument(o.version,d).setHasLocalMutations(),null})(n,e,t,r):n instanceof wn?(function(s,o,c,l){if(!Ms(s.precondition,o))return c;const d=Cd(s.fieldTransforms,l,o),f=o.data;return f.setAll(Yf(s)),f.setAll(d),o.convertToFoundDocument(o.version,f).setHasLocalMutations(),c===null?null:c.unionWith(s.fieldMask.fields).unionWith(s.fieldTransforms.map((p=>p.field)))})(n,e,t,r):(function(s,o,c){return Ms(s.precondition,o)?(o.convertToNoDocument(o.version).setHasLocalMutations(),null):c})(n,e,t)}function M_(n,e){let t=null;for(const r of n.fieldTransforms){const i=e.data.field(r.field),s=Hf(r.transform,i||null);s!=null&&(t===null&&(t=tt.empty()),t.set(r.field,s))}return t||null}function kd(n,e){return n.type===e.type&&!!n.key.isEqual(e.key)&&!!n.precondition.isEqual(e.precondition)&&!!(function(r,i){return r===void 0&&i===void 0||!(!r||!i)&&yr(r,i,((s,o)=>O_(s,o)))})(n.fieldTransforms,e.fieldTransforms)&&(n.type===0?n.value.isEqual(e.value):n.type!==1||n.data.isEqual(e.data)&&n.fieldMask.isEqual(e.fieldMask))}class Yi extends Oo{constructor(e,t,r,i=[]){super(),this.key=e,this.value=t,this.precondition=r,this.fieldTransforms=i,this.type=0}getFieldMask(){return null}}class wn extends Oo{constructor(e,t,r,i,s=[]){super(),this.key=e,this.data=t,this.fieldMask=r,this.precondition=i,this.fieldTransforms=s,this.type=1}getFieldMask(){return this.fieldMask}}function Yf(n){const e=new Map;return n.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const r=n.data.field(t);e.set(t,r)}})),e}function Sd(n,e,t){const r=new Map;de(n.length===t.length,32656,{Ae:t.length,Re:n.length});for(let i=0;i<t.length;i++){const s=n[i],o=s.transform,c=e.data.field(s.field);r.set(s.field,D_(o,c,t[i]))}return r}function Cd(n,e,t){const r=new Map;for(const i of n){const s=i.transform,o=t.data.field(i.field);r.set(i.field,P_(s,o,e))}return r}class Vo extends Oo{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class F_ extends Oo{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Lo{constructor(e,t,r,i,s){this.snapshotVersion=e,this.targetChanges=t,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,t,r){const i=new Map;return i.set(e,Xi.createSynthesizedTargetChangeForCurrentChange(e,t,r)),new Lo(Q.min(),i,new _e(re),jt(),oe())}}class Xi{constructor(e,t,r,i,s){this.resumeToken=e,this.current=t,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,t,r){return new Xi(r,t,oe(),oe(),oe())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ld="LruGarbageCollector",hw=1048576;function Md([n,e],[t,r]){const i=re(n,t);return i===0?re(e,r):i}class fw{constructor(e){this.Tr=e,this.buffer=new ke(Md),this.Ir=0}dr(){return++this.Ir}Er(e){const t=[e,this.dr()];if(this.buffer.size<this.Tr)this.buffer=this.buffer.add(t);else{const r=this.buffer.last();Md(t,r)<0&&(this.buffer=this.buffer.delete(r).add(t))}}get maxValue(){return this.buffer.last()[0]}}class pw{constructor(e,t,r){this.garbageCollector=e,this.asyncQueue=t,this.localStore=r,this.Ar=null}start(){this.garbageCollector.params.cacheSizeCollectionThreshold!==-1&&this.Rr(6e4)}stop(){this.Ar&&(this.Ar.cancel(),this.Ar=null)}get started(){return this.Ar!==null}Rr(e){$(Ld,`Garbage collection scheduled in ${e}ms`),this.Ar=this.asyncQueue.enqueueAfterDelay("lru_garbage_collection",e,(async()=>{this.Ar=null;try{await this.localStore.collectGarbage(this.garbageCollector)}catch(t){Dr(t)?$(Ld,"Ignoring IndexedDB error during garbage collection: ",t):await Pr(t)}await this.Rr(3e5)}))}}class mw{constructor(e,t){this.Vr=e,this.params=t}calculateTargetCount(e,t){return this.Vr.mr(e).next((r=>Math.floor(t/100*r)))}nthSequenceNumber(e,t){if(t===0)return D.resolve(ko.ue);const r=new fw(t);return this.Vr.forEachTarget(e,(i=>r.Er(i.sequenceNumber))).next((()=>this.Vr.gr(e,(i=>r.Er(i))))).next((()=>r.maxValue))}removeTargets(e,t,r){return this.Vr.removeTargets(e,t,r)}removeOrphanedDocuments(e,t){return this.Vr.removeOrphanedDocuments(e,t)}collect(e,t){return this.params.cacheSizeCollectionThreshold===-1?($("LruGarbageCollector","Garbage collection skipped; disabled"),D.resolve(Vd)):this.getCacheSize(e).next((r=>r<this.params.cacheSizeCollectionThreshold?($("LruGarbageCollector",`Garbage collection skipped; Cache size ${r} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`),Vd):this.pr(e,t)))}getCacheSize(e){return this.Vr.getCacheSize(e)}pr(e,t){let r,i,s,o,c,l,d;const f=Date.now();return this.calculateTargetCount(e,this.params.percentileToCollect).next((p=>(p>this.params.maximumSequenceNumbersToCollect?($("LruGarbageCollector",`Capping sequence numbers to collect down to the maximum of ${this.params.maximumSequenceNumbersToCollect} from ${p}`),i=this.params.maximumSequenceNumbersToCollect):i=p,o=Date.now(),this.nthSequenceNumber(e,i)))).next((p=>(r=p,c=Date.now(),this.removeTargets(e,r,t)))).next((p=>(s=p,l=Date.now(),this.removeOrphanedDocuments(e,r)))).next((p=>(d=Date.now(),rr()<=se.DEBUG&&$("LruGarbageCollector",`LRU Garbage Collection
	Counted targets in ${o-f}ms
	Determined least recently used ${i} in `+(c-o)+`ms
	Removed ${s} targets in `+(l-c)+`ms
	Removed ${p} documents in `+(d-l)+`ms
Total Duration: ${d-f}ms`),D.resolve({didRun:!0,sequenceNumbersCollected:i,targetsRemoved:s,documentsRemoved:p}))))}}function gw(n,e){return new mw(n,e)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _w{constructor(e,t,r,i){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=r,this.indexManager=i}getDocument(e,t){let r=null;return this.documentOverlayCache.getOverlay(e,t).next((i=>(r=i,this.remoteDocumentCache.getEntry(e,t)))).next((i=>(r!==null&&gi(r.mutation,i,ot.empty(),ye.now()),i)))}getDocuments(e,t){return this.remoteDocumentCache.getEntries(e,t).next((r=>this.getLocalViewOfDocuments(e,r,oe()).next((()=>r))))}getLocalViewOfDocuments(e,t,r=oe()){const i=Dn();return this.populateOverlays(e,i,t).next((()=>this.computeViews(e,t,i,r).next((s=>{let o=ii();return s.forEach(((c,l)=>{o=o.insert(c,l.overlayedDocument)})),o}))))}getOverlayedDocuments(e,t){const r=Dn();return this.populateOverlays(e,r,t).next((()=>this.computeViews(e,t,r,oe())))}populateOverlays(e,t,r){const i=[];return r.forEach((s=>{t.has(s)||i.push(s)})),this.documentOverlayCache.getOverlays(e,i).next((s=>{s.forEach(((o,c)=>{t.set(o,c)}))}))}computeViews(e,t,r,i){let s=jt();const o=mi(),c=(function(){return mi()})();return t.forEach(((l,d)=>{const f=r.get(d.key);i.has(d.key)&&(f===void 0||f.mutation instanceof wn)?s=s.insert(d.key,d):f!==void 0?(o.set(d.key,f.mutation.getFieldMask()),gi(f.mutation,d,f.mutation.getFieldMask(),ye.now())):o.set(d.key,ot.empty())})),this.recalculateAndSaveOverlays(e,s).next((l=>(l.forEach(((d,f)=>o.set(d,f))),t.forEach(((d,f)=>{var p;return c.set(d,new vw(f,(p=o.get(d))!==null&&p!==void 0?p:null))})),c)))}recalculateAndSaveOverlays(e,t){const r=mi();let i=new _e(((o,c)=>o-c)),s=oe();return this.mutationQueue.getAllMutationBatchesAffectingDocumentKeys(e,t).next((o=>{for(const c of o)c.keys().forEach((l=>{const d=t.get(l);if(d===null)return;let f=r.get(l)||ot.empty();f=c.applyToLocalView(d,f),r.set(l,f);const p=(i.get(c.batchId)||oe()).add(l);i=i.insert(c.batchId,p)}))})).next((()=>{const o=[],c=i.getReverseIterator();for(;c.hasNext();){const l=c.getNext(),d=l.key,f=l.value,p=zf();f.forEach((m=>{if(!s.has(m)){const _=Zf(t.get(m),r.get(m));_!==null&&p.set(m,_),s=s.add(m)}})),o.push(this.documentOverlayCache.saveOverlays(e,d,p))}return D.waitFor(o)})).next((()=>r))}recalculateAndSaveOverlaysForDocumentKeys(e,t){return this.remoteDocumentCache.getEntries(e,t).next((r=>this.recalculateAndSaveOverlays(e,r)))}getDocumentsMatchingQuery(e,t,r,i){return(function(o){return H.isDocumentKey(o.path)&&o.collectionGroup===null&&o.filters.length===0})(t)?this.getDocumentsMatchingDocumentQuery(e,t.path):Ff(t)?this.getDocumentsMatchingCollectionGroupQuery(e,t,r,i):this.getDocumentsMatchingCollectionQuery(e,t,r,i)}getNextDocuments(e,t,r,i){return this.remoteDocumentCache.getAllFromCollectionGroup(e,t,r,i).next((s=>{const o=i-s.size>0?this.documentOverlayCache.getOverlaysForCollectionGroup(e,t,r.largestBatchId,i-s.size):D.resolve(Dn());let c=wi,l=s;return o.next((d=>D.forEach(d,((f,p)=>(c<p.largestBatchId&&(c=p.largestBatchId),s.get(f)?D.resolve():this.remoteDocumentCache.getEntry(e,f).next((m=>{l=l.insert(f,m)}))))).next((()=>this.populateOverlays(e,d,s))).next((()=>this.computeViews(e,l,d,oe()))).next((f=>({batchId:c,changes:jf(f)})))))}))}getDocumentsMatchingDocumentQuery(e,t){return this.getDocument(e,new H(t)).next((r=>{let i=ii();return r.isFoundDocument()&&(i=i.insert(r.key,r)),i}))}getDocumentsMatchingCollectionGroupQuery(e,t,r,i){const s=t.collectionGroup;let o=ii();return this.indexManager.getCollectionParents(e,s).next((c=>D.forEach(c,(l=>{const d=(function(p,m){return new Nr(m,null,p.explicitOrderBy.slice(),p.filters.slice(),p.limit,p.limitType,p.startAt,p.endAt)})(t,l.child(s));return this.getDocumentsMatchingCollectionQuery(e,d,r,i).next((f=>{f.forEach(((p,m)=>{o=o.insert(p,m)}))}))})).next((()=>o))))}getDocumentsMatchingCollectionQuery(e,t,r,i){let s;return this.documentOverlayCache.getOverlaysForCollection(e,t.path,r.largestBatchId).next((o=>(s=o,this.remoteDocumentCache.getDocumentsMatchingQuery(e,t,r,s,i)))).next((o=>{s.forEach(((l,d)=>{const f=d.getKey();o.get(f)===null&&(o=o.insert(f,ze.newInvalidDocument(f)))}));let c=ii();return o.forEach(((l,d)=>{const f=s.get(l);f!==void 0&&gi(f.mutation,d,ot.empty(),ye.now()),Do(t,d)&&(c=c.insert(l,d))})),c}))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Cw{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=(function(){return by()?8:n_(He())>0?6:4})()}initialize(e,t){this.gs=e,this.indexManager=t,this.As=!0}getDocumentsMatchingQuery(e,t,r,i){const s={result:null};return this.ps(e,t).next((o=>{s.result=o})).next((()=>{if(!s.result)return this.ys(e,t,i,r).next((o=>{s.result=o}))})).next((()=>{if(s.result)return;const o=new Sw;return this.ws(e,t,o).next((c=>{if(s.result=c,this.Rs)return this.Ss(e,t,o,c.size)}))})).next((()=>s.result))}Ss(e,t,r,i){return r.documentReadCount<this.Vs?(rr()<=se.DEBUG&&$("QueryEngine","SDK will not create cache indexes for query:",ir(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),D.resolve()):(rr()<=se.DEBUG&&$("QueryEngine","Query:",ir(t),"scans",r.documentReadCount,"local documents and returns",i,"documents as results."),r.documentReadCount>this.fs*i?(rr()<=se.DEBUG&&$("QueryEngine","The SDK decides to create cache indexes for query:",ir(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,bt(t))):D.resolve())}ps(e,t){if(Ad(t))return D.resolve(null);let r=bt(t);return this.indexManager.getIndexType(e,r).next((i=>i===0?null:(t.limit!==null&&i===1&&(t=lc(t,null,"F"),r=bt(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next((s=>{const o=oe(...s);return this.gs.getDocuments(e,o).next((c=>this.indexManager.getMinOffset(e,r).next((l=>{const d=this.bs(t,c);return this.Ds(t,d,o,l.readTime)?this.ps(e,lc(t,null,"F")):this.vs(e,d,t,l)}))))})))))}ys(e,t,r,i){return Ad(t)||i.isEqual(Q.min())?D.resolve(null):this.gs.getDocuments(e,r).next((s=>{const o=this.bs(t,s);return this.Ds(t,o,r,i)?D.resolve(null):(rr()<=se.DEBUG&&$("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),ir(t)),this.vs(e,o,t,Xv(i,wi)).next((c=>c)))}))}bs(e,t){let r=new ke(Uf(e));return t.forEach(((i,s)=>{Do(e,s)&&(r=r.add(s))})),r}Ds(e,t,r,i){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const s=e.limitType==="F"?t.last():t.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}ws(e,t,r){return rr()<=se.DEBUG&&$("QueryEngine","Using full collection scan to execute query:",ir(t)),this.gs.getDocumentsMatchingQuery(e,t,un.min(),r)}vs(e,t,r,i){return this.gs.getDocumentsMatchingQuery(e,r,i).next((s=>(t.forEach((o=>{s=s.insert(o.key,o)})),s)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const el="LocalStore",Rw=3e8;class Pw{constructor(e,t,r,i){this.persistence=e,this.Cs=t,this.serializer=i,this.Fs=new _e(re),this.Ms=new zn((s=>Hc(s)),Wc),this.xs=new Map,this.Os=e.getRemoteDocumentCache(),this.hi=e.getTargetCache(),this.Ti=e.getBundleCache(),this.Ns(r)}Ns(e){this.documentOverlayCache=this.persistence.getDocumentOverlayCache(e),this.indexManager=this.persistence.getIndexManager(e),this.mutationQueue=this.persistence.getMutationQueue(e,this.indexManager),this.localDocuments=new _w(this.Os,this.mutationQueue,this.documentOverlayCache,this.indexManager),this.Os.setIndexManager(this.indexManager),this.Cs.initialize(this.localDocuments,this.indexManager)}collectGarbage(e){return this.persistence.runTransaction("Collect garbage","readwrite-primary",(t=>e.collect(t,this.Fs)))}}function Dw(n,e,t,r){return new Pw(n,e,t,r)}async function lp(n,e){const t=J(n);return await t.persistence.runTransaction("Handle user change","readonly",(r=>{let i;return t.mutationQueue.getAllMutationBatches(r).next((s=>(i=s,t.Ns(e),t.mutationQueue.getAllMutationBatches(r)))).next((s=>{const o=[],c=[];let l=oe();for(const d of i){o.push(d.batchId);for(const f of d.mutations)l=l.add(f.key)}for(const d of s){c.push(d.batchId);for(const f of d.mutations)l=l.add(f.key)}return t.localDocuments.getDocuments(r,l).next((d=>({Bs:d,removedBatchIds:o,addedBatchIds:c})))}))}))}function Nw(n,e){const t=J(n);return t.persistence.runTransaction("Acknowledge batch","readwrite-primary",(r=>{const i=e.batch.keys(),s=t.Os.newChangeBuffer({trackRemovals:!0});return(function(c,l,d,f){const p=d.batch,m=p.keys();let _=D.resolve();return m.forEach((C=>{_=_.next((()=>f.getEntry(l,C))).next((x=>{const A=d.docVersions.get(C);de(A!==null,48541),x.version.compareTo(A)<0&&(p.applyToRemoteDocument(x,d),x.isValidDocument()&&(x.setReadTime(d.commitVersion),f.addEntry(x)))}))})),_.next((()=>c.mutationQueue.removeMutationBatch(l,p)))})(t,r,e,s).next((()=>s.apply(r))).next((()=>t.mutationQueue.performConsistencyCheck(r))).next((()=>t.documentOverlayCache.removeOverlaysForBatchId(r,i,e.batch.batchId))).next((()=>t.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(r,(function(c){let l=oe();for(let d=0;d<c.mutationResults.length;++d)c.mutationResults[d].transformResults.length>0&&(l=l.add(c.batch.mutations[d].key));return l})(e)))).next((()=>t.localDocuments.getDocuments(r,i)))}))}function up(n){const e=J(n);return e.persistence.runTransaction("Get last remote snapshot version","readonly",(t=>e.hi.getLastRemoteSnapshotVersion(t)))}function Ow(n,e){const t=J(n),r=e.snapshotVersion;let i=t.Fs;return t.persistence.runTransaction("Apply remote event","readwrite-primary",(s=>{const o=t.Os.newChangeBuffer({trackRemovals:!0});i=t.Fs;const c=[];e.targetChanges.forEach(((f,p)=>{const m=i.get(p);if(!m)return;c.push(t.hi.removeMatchingKeys(s,f.removedDocuments,p).next((()=>t.hi.addMatchingKeys(s,f.addedDocuments,p))));let _=m.withSequenceNumber(s.currentSequenceNumber);e.targetMismatches.get(p)!==null?_=_.withResumeToken(Me.EMPTY_BYTE_STRING,Q.min()).withLastLimboFreeSnapshotVersion(Q.min()):f.resumeToken.approximateByteSize()>0&&(_=_.withResumeToken(f.resumeToken,r)),i=i.insert(p,_),(function(x,A,N){return x.resumeToken.approximateByteSize()===0||A.snapshotVersion.toMicroseconds()-x.snapshotVersion.toMicroseconds()>=Rw?!0:N.addedDocuments.size+N.modifiedDocuments.size+N.removedDocuments.size>0})(m,_,f)&&c.push(t.hi.updateTargetData(s,_))}));let l=jt(),d=oe();if(e.documentUpdates.forEach((f=>{e.resolvedLimboDocuments.has(f)&&c.push(t.persistence.referenceDelegate.updateLimboDocument(s,f))})),c.push(Vw(s,o,e.documentUpdates).next((f=>{l=f.Ls,d=f.ks}))),!r.isEqual(Q.min())){const f=t.hi.getLastRemoteSnapshotVersion(s).next((p=>t.hi.setTargetsMetadata(s,s.currentSequenceNumber,r)));c.push(f)}return D.waitFor(c).next((()=>o.apply(s))).next((()=>t.localDocuments.getLocalViewOfDocuments(s,l,d))).next((()=>l))})).then((s=>(t.Fs=i,s)))}function Vw(n,e,t){let r=oe(),i=oe();return t.forEach((s=>r=r.add(s))),e.getEntries(n,r).next((s=>{let o=jt();return t.forEach(((c,l)=>{const d=s.get(c);l.isFoundDocument()!==d.isFoundDocument()&&(i=i.add(c)),l.isNoDocument()&&l.version.isEqual(Q.min())?(e.removeEntry(c,l.readTime),o=o.insert(c,l)):!d.isValidDocument()||l.version.compareTo(d.version)>0||l.version.compareTo(d.version)===0&&d.hasPendingWrites?(e.addEntry(l),o=o.insert(c,l)):$(el,"Ignoring outdated watch update for ",c,". Current version:",d.version," Watch version:",l.version)})),{Ls:o,ks:i}}))}function Lw(n,e){const t=J(n);return t.persistence.runTransaction("Get next mutation batch","readonly",(r=>(e===void 0&&(e=jc),t.mutationQueue.getNextMutationBatchAfterBatchId(r,e))))}function Mw(n,e){const t=J(n);return t.persistence.runTransaction("Allocate target","readwrite",(r=>{let i;return t.hi.getTargetData(r,e).next((s=>s?(i=s,D.resolve(i)):t.hi.allocateTargetId(r).next((o=>(i=new tn(e,o,"TargetPurposeListen",r.currentSequenceNumber),t.hi.addTargetData(r,i).next((()=>i)))))))})).then((r=>{const i=t.Fs.get(r.targetId);return(i===null||r.snapshotVersion.compareTo(i.snapshotVersion)>0)&&(t.Fs=t.Fs.insert(r.targetId,r),t.Ms.set(e,r.targetId)),r}))}async function pc(n,e,t){const r=J(n),i=r.Fs.get(e),s=t?"readwrite":"readwrite-primary";try{t||await r.persistence.runTransaction("Release target",s,(o=>r.persistence.referenceDelegate.removeTarget(o,i)))}catch(o){if(!Dr(o))throw o;$(el,`Failed to update sequence numbers for target ${e}: ${o}`)}r.Fs=r.Fs.remove(e),r.Ms.delete(i.target)}function Fd(n,e,t){const r=J(n);let i=Q.min(),s=oe();return r.persistence.runTransaction("Execute query","readwrite",(o=>(function(l,d,f){const p=J(l),m=p.Ms.get(f);return m!==void 0?D.resolve(p.Fs.get(m)):p.hi.getTargetData(d,f)})(r,o,bt(e)).next((c=>{if(c)return i=c.lastLimboFreeSnapshotVersion,r.hi.getMatchingKeysForTargetId(o,c.targetId).next((l=>{s=l}))})).next((()=>r.Cs.getDocumentsMatchingQuery(o,e,t?i:Q.min(),t?s:oe()))).next((c=>(Fw(r,I_(e),c),{documents:c,qs:s})))))}function Fw(n,e,t){let r=n.xs.get(e)||Q.min();t.forEach(((i,s)=>{s.readTime.compareTo(r)>0&&(r=s.readTime)})),n.xs.set(e,r)}class Bd{constructor(){this.activeTargetIds=C_()}Gs(e){this.activeTargetIds=this.activeTargetIds.add(e)}zs(e){this.activeTargetIds=this.activeTargetIds.delete(e)}Ws(){const e={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()};return JSON.stringify(e)}}class Bw{constructor(){this.Fo=new Bd,this.Mo={},this.onlineStateHandler=null,this.sequenceNumberHandler=null}addPendingMutation(e){}updateMutationState(e,t,r){}addLocalQueryTarget(e,t=!0){return t&&this.Fo.Gs(e),this.Mo[e]||"not-current"}updateQueryState(e,t,r){this.Mo[e]=t}removeLocalQueryTarget(e){this.Fo.zs(e)}isLocalQueryTarget(e){return this.Fo.activeTargetIds.has(e)}clearQueryState(e){delete this.Mo[e]}getAllActiveQueryTargets(){return this.Fo.activeTargetIds}isActiveQueryTarget(e){return this.Fo.activeTargetIds.has(e)}start(){return this.Fo=new Bd,Promise.resolve()}handleUserChange(e,t,r){}setOnlineState(e){}shutdown(){}writeSequenceNumber(e){}notifyBundleLoaded(e){}}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ud="ConnectivityMonitor";class $d{constructor(){this.Oo=()=>this.No(),this.Bo=()=>this.Lo(),this.ko=[],this.qo()}xo(e){this.ko.push(e)}shutdown(){window.removeEventListener("online",this.Oo),window.removeEventListener("offline",this.Bo)}qo(){window.addEventListener("online",this.Oo),window.addEventListener("offline",this.Bo)}No(){$(Ud,"Network connectivity changed: AVAILABLE");for(const e of this.ko)e(0)}Lo(){$(Ud,"Network connectivity changed: UNAVAILABLE");for(const e of this.ko)e(1)}static C(){return typeof window<"u"&&window.addEventListener!==void 0&&window.removeEventListener!==void 0}}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Oa="RestConnection",$w={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class jw{get Qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",r=encodeURIComponent(this.databaseId.projectId),i=encodeURIComponent(this.databaseId.database);this.$o=t+"://"+e.host,this.Uo=`projects/${r}/databases/${i}`,this.Ko=this.databaseId.database===Xs?`project_id=${r}`:`project_id=${r}&database_id=${i}`}Wo(e,t,r,i,s){const o=mc(),c=this.Go(e,t.toUriEncodedString());$(Oa,`Sending RPC '${e}' ${o}:`,c,r);const l={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.Ko};this.zo(l,i,s);const{host:d}=new URL(c),f=Sr(d);return this.jo(e,c,l,r,f).then((p=>($(Oa,`Received RPC '${e}' ${o}: `,p),p)),(p=>{throw ln(Oa,`RPC '${e}' ${o} failed with error: `,p,"url: ",c,"request:",r),p}))}Jo(e,t,r,i,s,o){return this.Wo(e,t,r,i,s)}zo(e,t,r){e["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+Rr})(),e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach(((i,s)=>e[s]=i)),r&&r.headers.forEach(((i,s)=>e[s]=i))}Go(e,t){const r=$w[e];return`${this.$o}/v1/${t}:${r}`}terminate(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const $e="WebChannelConnection";class qw extends jw{constructor(e){super(e),this.u_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}jo(e,t,r,i,s){const o=mc();return new Promise(((c,l)=>{const d=new hf;d.setWithCredentials(!0),d.listenOnce(ff.COMPLETE,(()=>{try{switch(d.getLastErrorCode()){case Os.NO_ERROR:const p=d.getResponseJson();$($e,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),c(p);break;case Os.TIMEOUT:$($e,`RPC '${e}' ${o} timed out`),l(new F(P.DEADLINE_EXCEEDED,"Request time out"));break;case Os.HTTP_ERROR:const m=d.getStatus();if($($e,`RPC '${e}' ${o} failed with status:`,m,"response text:",d.getResponseText()),m>0){let _=d.getResponseJson();Array.isArray(_)&&(_=_[0]);const C=_==null?void 0:_.error;if(C&&C.status&&C.message){const x=(function(N){const O=N.toLowerCase().replace(/_/g,"-");return Object.values(P).indexOf(O)>=0?O:P.UNKNOWN})(C.status);l(new F(x,C.message))}else l(new F(P.UNKNOWN,"Server responded with status "+d.getStatus()))}else l(new F(P.UNAVAILABLE,"Connection failed."));break;default:K(9055,{c_:e,streamId:o,l_:d.getLastErrorCode(),h_:d.getLastError()})}}finally{$($e,`RPC '${e}' ${o} completed.`)}}));const f=JSON.stringify(i);$($e,`RPC '${e}' ${o} sending request:`,i),d.send(t,"POST",f,r,15)}))}P_(e,t,r){const i=mc(),s=[this.$o,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=gf(),c=mf(),l={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},d=this.longPollingOptions.timeoutSeconds;d!==void 0&&(l.longPollingTimeout=Math.round(1e3*d)),this.useFetchStreams&&(l.useFetchStreams=!0),this.zo(l.initMessageHeaders,t,r),l.encodeInitMessageHeaders=!0;const f=s.join("");$($e,`Creating RPC '${e}' stream ${i}: ${f}`,l);const p=o.createWebChannel(f,l);this.T_(p);let m=!1,_=!1;const C=new zw({Ho:A=>{_?$($e,`Not sending because RPC '${e}' stream ${i} is closed:`,A):(m||($($e,`Opening RPC '${e}' stream ${i} transport.`),p.open(),m=!0),$($e,`RPC '${e}' stream ${i} sending:`,A),p.send(A))},Yo:()=>p.close()}),x=(A,N,O)=>{A.listen(N,(B=>{try{O(B)}catch(q){setTimeout((()=>{throw q}),0)}}))};return x(p,ri.EventType.OPEN,(()=>{_||($($e,`RPC '${e}' stream ${i} transport opened.`),C.s_())})),x(p,ri.EventType.CLOSE,(()=>{_||(_=!0,$($e,`RPC '${e}' stream ${i} transport closed`),C.__(),this.I_(p))})),x(p,ri.EventType.ERROR,(A=>{_||(_=!0,ln($e,`RPC '${e}' stream ${i} transport errored. Name:`,A.name,"Message:",A.message),C.__(new F(P.UNAVAILABLE,"The operation could not be completed")))})),x(p,ri.EventType.MESSAGE,(A=>{var N;if(!_){const O=A.data[0];de(!!O,16349);const B=O,q=(B==null?void 0:B.error)||((N=B[0])===null||N===void 0?void 0:N.error);if(q){$($e,`RPC '${e}' stream ${i} received error:`,q);const fe=q.status;let ie=(function(w){const T=Ie[w];if(T!==void 0)return Xf(T)})(fe),I=q.message;ie===void 0&&(ie=P.INTERNAL,I="Unknown error status: "+fe+" with message "+q.message),_=!0,C.__(new F(ie,I)),p.close()}else $($e,`RPC '${e}' stream ${i} received:`,O),C.a_(O)}})),x(c,pf.STAT_EVENT,(A=>{A.stat===nc.PROXY?$($e,`RPC '${e}' stream ${i} detected buffering proxy`):A.stat===nc.NOPROXY&&$($e,`RPC '${e}' stream ${i} detected no buffering proxy`)})),setTimeout((()=>{C.o_()}),0),C}terminate(){this.u_.forEach((e=>e.close())),this.u_=[]}T_(e){this.u_.push(e)}I_(e){this.u_=this.u_.filter((t=>t===e))}}function Va(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dp{constructor(e,t,r=1e3,i=1.5,s=6e4){this.Fi=e,this.timerId=t,this.d_=r,this.E_=i,this.A_=s,this.R_=0,this.V_=null,this.m_=Date.now(),this.reset()}reset(){this.R_=0}f_(){this.R_=this.A_}g_(e){this.cancel();const t=Math.floor(this.R_+this.p_()),r=Math.max(0,Date.now()-this.m_),i=Math.max(0,t-r);i>0&&$("ExponentialBackoff",`Backing off for ${i} ms (base delay: ${this.R_} ms, delay with jitter: ${t} ms, last attempt: ${r} ms ago)`),this.V_=this.Fi.enqueueAfterDelay(this.timerId,i,(()=>(this.m_=Date.now(),e()))),this.R_*=this.E_,this.R_<this.d_&&(this.R_=this.d_),this.R_>this.A_&&(this.R_=this.A_)}y_(){this.V_!==null&&(this.V_.skipDelay(),this.V_=null)}cancel(){this.V_!==null&&(this.V_.cancel(),this.V_=null)}p_(){return(Math.random()-.5)*this.R_}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jd="PersistentStream";class hp{constructor(e,t,r,i,s,o,c,l){this.Fi=e,this.w_=r,this.S_=i,this.connection=s,this.authCredentialsProvider=o,this.appCheckCredentialsProvider=c,this.listener=l,this.state=0,this.b_=0,this.D_=null,this.v_=null,this.stream=null,this.C_=0,this.F_=new dp(e,t)}M_(){return this.state===1||this.state===5||this.x_()}x_(){return this.state===2||this.state===3}start(){this.C_=0,this.state!==4?this.auth():this.O_()}async stop(){this.M_()&&await this.close(0)}N_(){this.state=0,this.F_.reset()}B_(){this.x_()&&this.D_===null&&(this.D_=this.Fi.enqueueAfterDelay(this.w_,6e4,(()=>this.L_())))}k_(e){this.q_(),this.stream.send(e)}async L_(){if(this.x_())return this.close(0)}q_(){this.D_&&(this.D_.cancel(),this.D_=null)}Q_(){this.v_&&(this.v_.cancel(),this.v_=null)}async close(e,t){this.q_(),this.Q_(),this.F_.cancel(),this.b_++,e!==4?this.F_.reset():t&&t.code===P.RESOURCE_EXHAUSTED?($t(t.toString()),$t("Using maximum backoff delay to prevent overloading the backend."),this.F_.f_()):t&&t.code===P.UNAUTHENTICATED&&this.state!==3&&(this.authCredentialsProvider.invalidateToken(),this.appCheckCredentialsProvider.invalidateToken()),this.stream!==null&&(this.U_(),this.stream.close(),this.stream=null),this.state=e,await this.listener.n_(t)}U_(){}auth(){this.state=1;const e=this.K_(this.b_),t=this.b_;Promise.all([this.authCredentialsProvider.getToken(),this.appCheckCredentialsProvider.getToken()]).then((([r,i])=>{this.b_===t&&this.W_(r,i)}),(r=>{e((()=>{const i=new F(P.UNKNOWN,"Fetching auth token failed: "+r.message);return this.G_(i)}))}))}W_(e,t){const r=this.K_(this.b_);this.stream=this.z_(e,t),this.stream.Zo((()=>{r((()=>this.listener.Zo()))})),this.stream.e_((()=>{r((()=>(this.state=2,this.v_=this.Fi.enqueueAfterDelay(this.S_,1e4,(()=>(this.x_()&&(this.state=3),Promise.resolve()))),this.listener.e_())))})),this.stream.n_((i=>{r((()=>this.G_(i)))})),this.stream.onMessage((i=>{r((()=>++this.C_==1?this.j_(i):this.onNext(i)))}))}O_(){this.state=5,this.F_.g_((async()=>{this.state=0,this.start()}))}G_(e){return $(jd,`close with error: ${e}`),this.stream=null,this.close(4,e)}K_(e){return t=>{this.Fi.enqueueAndForget((()=>this.b_===e?t():($(jd,"stream callback skipped by getCloseGuardedDispatcher."),Promise.resolve())))}}}class Hw extends hp{constructor(e,t,r,i,s,o){super(e,"listen_stream_connection_backoff","listen_stream_idle","health_check_timeout",t,r,i,o),this.serializer=s}z_(e,t){return this.connection.P_("Listen",e,t)}j_(e){return this.onNext(e)}onNext(e){this.F_.reset();const t=X_(this.serializer,e),r=(function(s){if(!("targetChange"in s))return Q.min();const o=s.targetChange;return o.targetIds&&o.targetIds.length?Q.min():o.readTime?Et(o.readTime):Q.min()})(e);return this.listener.J_(t,r)}H_(e){const t={};t.database=fc(this.serializer),t.addTarget=(function(s,o){let c;const l=o.target;if(c=ac(l)?{documents:ew(s,l)}:{query:tw(s,l).Vt},c.targetId=o.targetId,o.resumeToken.approximateByteSize()>0){c.resumeToken=ep(s,o.resumeToken);const d=uc(s,o.expectedCount);d!==null&&(c.expectedCount=d)}else if(o.snapshotVersion.compareTo(Q.min())>0){c.readTime=to(s,o.snapshotVersion.toTimestamp());const d=uc(s,o.expectedCount);d!==null&&(c.expectedCount=d)}return c})(this.serializer,e);const r=rw(this.serializer,e);r&&(t.labels=r),this.k_(t)}Y_(e){const t={};t.database=fc(this.serializer),t.removeTarget=e,this.k_(t)}}class Ww extends hp{constructor(e,t,r,i,s,o){super(e,"write_stream_connection_backoff","write_stream_idle","health_check_timeout",t,r,i,o),this.serializer=s}get Z_(){return this.C_>0}start(){this.lastStreamToken=void 0,super.start()}U_(){this.Z_&&this.X_([])}z_(e,t){return this.connection.P_("Write",e,t)}j_(e){return de(!!e.streamToken,31322),this.lastStreamToken=e.streamToken,de(!e.writeResults||e.writeResults.length===0,55816),this.listener.ea()}onNext(e){de(!!e.streamToken,12678),this.lastStreamToken=e.streamToken,this.F_.reset();const t=J_(e.writeResults,e.commitTime),r=Et(e.commitTime);return this.listener.ta(r,t)}na(){const e={};e.database=fc(this.serializer),this.k_(e)}X_(e){const t={streamToken:this.lastStreamToken,writes:e.map((r=>Q_(this.serializer,r)))};this.k_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Bn="RemoteStore";class Yw{constructor(e,t,r,i,s){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=s,this.Ea.xo((o=>{r.enqueueAndForget((async()=>{qn(this)&&($(Bn,"Restarting streams for network reachability change."),await(async function(l){const d=J(l);d.Ia.add(4),await Qi(d),d.Aa.set("Unknown"),d.Ia.delete(4),await Fo(d)})(this))}))})),this.Aa=new Zw(r,i)}}async function Fo(n){if(qn(n))for(const e of n.da)await e(!0)}async function Qi(n){for(const e of n.da)await e(!1)}function fp(n,e){const t=J(n);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),il(t)?rl(t):Or(t).x_()&&nl(t,e))}function tl(n,e){const t=J(n),r=Or(t);t.Ta.delete(e),r.x_()&&pp(t,e),t.Ta.size===0&&(r.x_()?r.B_():qn(t)&&t.Aa.set("Unknown"))}function nl(n,e){if(n.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(Q.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}Or(n).H_(e)}function pp(n,e){n.Ra.$e(e),Or(n).Y_(e)}function rl(n){n.Ra=new q_({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>n.Ta.get(e)||null,lt:()=>n.datastore.serializer.databaseId}),Or(n).start(),n.Aa.aa()}function il(n){return qn(n)&&!Or(n).M_()&&n.Ta.size>0}function qn(n){return J(n).Ia.size===0}function mp(n){n.Ra=void 0}async function Xw(n){n.Aa.set("Online")}async function Qw(n){n.Ta.forEach(((e,t)=>{nl(n,e)}))}async function Jw(n,e){mp(n),il(n)?(n.Aa.la(e),rl(n)):n.Aa.set("Unknown")}async function e0(n,e,t){if(n.Aa.set("Online"),e instanceof Jf&&e.state===2&&e.cause)try{await(async function(i,s){const o=s.cause;for(const c of s.targetIds)i.Ta.has(c)&&(await i.remoteSyncer.rejectListen(c,o),i.Ta.delete(c),i.Ra.removeTarget(c))})(n,e)}catch(r){$(Bn,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await ro(n,r)}else if(e instanceof Fs?n.Ra.Ye(e):e instanceof Qf?n.Ra.it(e):n.Ra.et(e),!t.isEqual(Q.min()))try{const r=await up(n.localStore);t.compareTo(r)>=0&&await(function(s,o){const c=s.Ra.Pt(o);return c.targetChanges.forEach(((l,d)=>{if(l.resumeToken.approximateByteSize()>0){const f=s.Ta.get(d);f&&s.Ta.set(d,f.withResumeToken(l.resumeToken,o))}})),c.targetMismatches.forEach(((l,d)=>{const f=s.Ta.get(l);if(!f)return;s.Ta.set(l,f.withResumeToken(Me.EMPTY_BYTE_STRING,f.snapshotVersion)),pp(s,l);const p=new tn(f.target,l,d,f.sequenceNumber);nl(s,p)})),s.remoteSyncer.applyRemoteEvent(c)})(n,t)}catch(r){$(Bn,"Failed to raise snapshot:",r),await ro(n,r)}}async function ro(n,e,t){if(!Dr(e))throw e;n.Ia.add(1),await Qi(n),n.Aa.set("Offline"),t||(t=()=>up(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{$(Bn,"Retrying IndexedDB access"),await t(),n.Ia.delete(1),await Fo(n)}))}function gp(n,e){return e().catch((t=>ro(n,t,e)))}async function Bo(n){const e=J(n),t=pn(e);let r=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:jc;for(;t0(e);)try{const i=await Lw(e.localStore,r);if(i===null){e.Pa.length===0&&t.B_();break}r=i.batchId,n0(e,i)}catch(i){await ro(e,i)}yp(e)&&vp(e)}function t0(n){return qn(n)&&n.Pa.length<10}function n0(n,e){n.Pa.push(e);const t=pn(n);t.x_()&&t.Z_&&t.X_(e.mutations)}function yp(n){return qn(n)&&!pn(n).M_()&&n.Pa.length>0}function vp(n){pn(n).start()}async function r0(n){pn(n).na()}async function i0(n){const e=pn(n);for(const t of n.Pa)e.X_(t.mutations)}async function s0(n,e,t){const r=n.Pa.shift(),i=Kc.from(r,e,t);await gp(n,(()=>n.remoteSyncer.applySuccessfulWrite(i))),await Bo(n)}async function o0(n,e){e&&pn(n).Z_&&await(async function(r,i){if((function(o){return j_(o)&&o!==P.ABORTED})(i.code)){const s=r.Pa.shift();pn(r).N_(),await gp(r,(()=>r.remoteSyncer.rejectFailedWrite(s.batchId,i))),await Bo(r)}})(n,e),yp(n)&&vp(n)}async function zd(n,e){const t=J(n);t.asyncQueue.verifyOperationInProgress(),$(Bn,"RemoteStore received new credentials");const r=qn(t);t.Ia.add(3),await Qi(t),r&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await Fo(t)}async function a0(n,e){const t=J(n);e?(t.Ia.delete(2),await Fo(t)):e||(t.Ia.add(2),await Qi(t),t.Aa.set("Unknown"))}function Or(n){return n.Va||(n.Va=(function(t,r,i){const s=J(t);return s.ia(),new Hw(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)})(n.datastore,n.asyncQueue,{Zo:Xw.bind(null,n),e_:Qw.bind(null,n),n_:Jw.bind(null,n),J_:e0.bind(null,n)}),n.da.push((async e=>{e?(n.Va.N_(),il(n)?rl(n):n.Aa.set("Unknown")):(await n.Va.stop(),mp(n))}))),n.Va}function pn(n){return n.ma||(n.ma=(function(t,r,i){const s=J(t);return s.ia(),new Ww(r,s.connection,s.authCredentials,s.appCheckCredentials,s.serializer,i)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),e_:r0.bind(null,n),n_:o0.bind(null,n),ea:i0.bind(null,n),ta:s0.bind(null,n)}),n.da.push((async e=>{e?(n.ma.N_(),await Bo(n)):(await n.ma.stop(),n.Pa.length>0&&($(Bn,`Stopping write stream with ${n.Pa.length} pending writes`),n.Pa=[]))}))),n.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class qd{constructor(){this.fa=new _e(H.comparator)}track(e){const t=e.doc.key,r=this.fa.get(t);r?e.type!==0&&r.type===3?this.fa=this.fa.insert(t,e):e.type===3&&r.type!==1?this.fa=this.fa.insert(t,{type:r.type,doc:e.doc}):e.type===2&&r.type===2?this.fa=this.fa.insert(t,{type:2,doc:e.doc}):e.type===2&&r.type===0?this.fa=this.fa.insert(t,{type:0,doc:e.doc}):e.type===1&&r.type===0?this.fa=this.fa.remove(t):e.type===1&&r.type===2?this.fa=this.fa.insert(t,{type:1,doc:r.doc}):e.type===0&&r.type===1?this.fa=this.fa.insert(t,{type:2,doc:e.doc}):K(63341,{At:e,ga:r}):this.fa=this.fa.insert(t,e)}pa(){const e=[];return this.fa.inorderTraversal(((t,r)=>{e.push(r)})),e}}class br{constructor(e,t,r,i,s,o,c,l,d){this.query=e,this.docs=t,this.oldDocs=r,this.docChanges=i,this.mutatedKeys=s,this.fromCache=o,this.syncStateChanged=c,this.excludesMetadataChanges=l,this.hasCachedResults=d}static fromInitialDocuments(e,t,r,i,s){const o=[];return t.forEach((c=>{o.push({type:0,doc:c})})),new br(e,t,hr.emptySet(t),o,r,i,!0,!1,s)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&Po(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;const t=this.docChanges,r=e.docChanges;if(t.length!==r.length)return!1;for(let i=0;i<t.length;i++)if(t[i].type!==r[i].type||!t[i].doc.isEqual(r[i].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _p{constructor(e){this.key=e}}class wp{constructor(e){this.key=e}}class h0{constructor(e,t){this.query=e,this.Ha=t,this.Ya=null,this.hasCachedResults=!1,this.current=!1,this.Za=oe(),this.mutatedKeys=oe(),this.Xa=Uf(e),this.eu=new hr(this.Xa)}get tu(){return this.Ha}nu(e,t){const r=t?t.ru:new qd,i=t?t.eu:this.eu;let s=t?t.mutatedKeys:this.mutatedKeys,o=i,c=!1;const l=this.query.limitType==="F"&&i.size===this.query.limit?i.last():null,d=this.query.limitType==="L"&&i.size===this.query.limit?i.first():null;if(e.inorderTraversal(((f,p)=>{const m=i.get(f),_=Do(this.query,p)?p:null,C=!!m&&this.mutatedKeys.has(m.key),x=!!_&&(_.hasLocalMutations||this.mutatedKeys.has(_.key)&&_.hasCommittedMutations);let A=!1;m&&_?m.data.isEqual(_.data)?C!==x&&(r.track({type:3,doc:_}),A=!0):this.iu(m,_)||(r.track({type:2,doc:_}),A=!0,(l&&this.Xa(_,l)>0||d&&this.Xa(_,d)<0)&&(c=!0)):!m&&_?(r.track({type:0,doc:_}),A=!0):m&&!_&&(r.track({type:1,doc:m}),A=!0,(l||d)&&(c=!0)),A&&(_?(o=o.add(_),s=x?s.add(f):s.delete(f)):(o=o.delete(f),s=s.delete(f)))})),this.query.limit!==null)for(;o.size>this.query.limit;){const f=this.query.limitType==="F"?o.last():o.first();o=o.delete(f.key),s=s.delete(f.key),r.track({type:1,doc:f})}return{eu:o,ru:r,Ds:c,mutatedKeys:s}}iu(e,t){return e.hasLocalMutations&&t.hasCommittedMutations&&!t.hasLocalMutations}applyChanges(e,t,r,i){const s=this.eu;this.eu=e.eu,this.mutatedKeys=e.mutatedKeys;const o=e.ru.pa();o.sort(((f,p)=>(function(_,C){const x=A=>{switch(A){case 0:return 1;case 2:case 3:return 2;case 1:return 0;default:return K(20277,{At:A})}};return x(_)-x(C)})(f.type,p.type)||this.Xa(f.doc,p.doc))),this.su(r),i=i!=null&&i;const c=t&&!i?this.ou():[],l=this.Za.size===0&&this.current&&!i?1:0,d=l!==this.Ya;return this.Ya=l,o.length!==0||d?{snapshot:new br(this.query,e.eu,s,o,e.mutatedKeys,l===0,d,!1,!!r&&r.resumeToken.approximateByteSize()>0),_u:c}:{_u:c}}va(e){return this.current&&e==="Offline"?(this.current=!1,this.applyChanges({eu:this.eu,ru:new qd,mutatedKeys:this.mutatedKeys,Ds:!1},!1)):{_u:[]}}au(e){return!this.Ha.has(e)&&!!this.eu.has(e)&&!this.eu.get(e).hasLocalMutations}su(e){e&&(e.addedDocuments.forEach((t=>this.Ha=this.Ha.add(t))),e.modifiedDocuments.forEach((t=>{})),e.removedDocuments.forEach((t=>this.Ha=this.Ha.delete(t))),this.current=e.current)}ou(){if(!this.current)return[];const e=this.Za;this.Za=oe(),this.eu.forEach((r=>{this.au(r.key)&&(this.Za=this.Za.add(r.key))}));const t=[];return e.forEach((r=>{this.Za.has(r)||t.push(new wp(r))})),this.Za.forEach((r=>{e.has(r)||t.push(new _p(r))})),t}uu(e){this.Ha=e.qs,this.Za=oe();const t=this.nu(e.documents);return this.applyChanges(t,!0)}cu(){return br.fromInitialDocuments(this.query,this.eu,this.mutatedKeys,this.Ya===0,this.hasCachedResults)}}const dl="SyncEngine";class f0{constructor(e,t,r){this.query=e,this.targetId=t,this.view=r}}class p0{constructor(e){this.key=e,this.lu=!1}}class m0{constructor(e,t,r,i,s,o){this.localStore=e,this.remoteStore=t,this.eventManager=r,this.sharedClientState=i,this.currentUser=s,this.maxConcurrentLimboResolutions=o,this.hu={},this.Pu=new zn((c=>Bf(c)),Po),this.Tu=new Map,this.Iu=new Set,this.du=new _e(H.comparator),this.Eu=new Map,this.Au=new Xc,this.Ru={},this.Vu=new Map,this.mu=wr.ur(),this.onlineState="Unknown",this.fu=void 0}get isPrimaryClient(){return this.fu===!0}}async function g0(n,e,t=!0){const r=xp(n);let i;const s=r.Pu.get(e);return s?(r.sharedClientState.addLocalQueryTarget(s.targetId),i=s.view.cu()):i=await bp(r,e,t,!0),i}async function y0(n,e){const t=xp(n);await bp(t,e,!0,!1)}async function bp(n,e,t,r){const i=await Mw(n.localStore,bt(e)),s=i.targetId,o=n.sharedClientState.addLocalQueryTarget(s,t);let c;return r&&(c=await v0(n,e,s,o==="current",i.resumeToken)),n.isPrimaryClient&&t&&fp(n.remoteStore,i),c}async function v0(n,e,t,r,i){n.gu=(p,m,_)=>(async function(x,A,N,O){let B=A.view.nu(N);B.Ds&&(B=await Fd(x.localStore,A.query,!1).then((({documents:I})=>A.view.nu(I,B))));const q=O&&O.targetChanges.get(A.targetId),fe=O&&O.targetMismatches.get(A.targetId)!=null,ie=A.view.applyChanges(B,x.isPrimaryClient,q,fe);return Kd(x,A.targetId,ie._u),ie.snapshot})(n,p,m,_);const s=await Fd(n.localStore,e,!0),o=new h0(e,s.qs),c=o.nu(s.documents),l=Xi.createSynthesizedTargetChangeForCurrentChange(t,r&&n.onlineState!=="Offline",i),d=o.applyChanges(c,n.isPrimaryClient,l);Kd(n,t,d._u);const f=new f0(e,t,o);return n.Pu.set(e,f),n.Tu.has(t)?n.Tu.get(t).push(e):n.Tu.set(t,[e]),d.snapshot}async function _0(n,e,t){const r=J(n),i=r.Pu.get(e),s=r.Tu.get(i.targetId);if(s.length>1)return r.Tu.set(i.targetId,s.filter((o=>!Po(o,e)))),void r.Pu.delete(e);r.isPrimaryClient?(r.sharedClientState.removeLocalQueryTarget(i.targetId),r.sharedClientState.isActiveQueryTarget(i.targetId)||await pc(r.localStore,i.targetId,!1).then((()=>{r.sharedClientState.clearQueryState(i.targetId),t&&tl(r.remoteStore,i.targetId),yc(r,i.targetId)})).catch(Pr)):(yc(r,i.targetId),await pc(r.localStore,i.targetId,!0))}async function w0(n,e){const t=J(n),r=t.Pu.get(e),i=t.Tu.get(r.targetId);t.isPrimaryClient&&i.length===1&&(t.sharedClientState.removeLocalQueryTarget(r.targetId),tl(t.remoteStore,r.targetId))}async function b0(n,e,t){const r=S0(n);try{const i=await(function(o,c){const l=J(o),d=ye.now(),f=c.reduce(((_,C)=>_.add(C.key)),oe());let p,m;return l.persistence.runTransaction("Locally write mutations","readwrite",(_=>{let C=jt(),x=oe();return l.Os.getEntries(_,f).next((A=>{C=A,C.forEach(((N,O)=>{O.isValidDocument()||(x=x.add(N))}))})).next((()=>l.localDocuments.getOverlayedDocuments(_,C))).next((A=>{p=A;const N=[];for(const O of c){const B=M_(O,p.get(O.key).overlayedDocument);B!=null&&N.push(new wn(O.key,B,Pf(B.value.mapValue),Ye.exists(!0)))}return l.mutationQueue.addMutationBatch(_,d,N,c)})).next((A=>{m=A;const N=A.applyToLocalDocumentSet(p,x);return l.documentOverlayCache.saveOverlays(_,A.batchId,N)}))})).then((()=>({batchId:m.batchId,changes:jf(p)})))})(r.localStore,e);r.sharedClientState.addPendingMutation(i.batchId),(function(o,c,l){let d=o.Ru[o.currentUser.toKey()];d||(d=new _e(re)),d=d.insert(c,l),o.Ru[o.currentUser.toKey()]=d})(r,i.batchId,t),await Ji(r,i.changes),await Bo(r.remoteStore)}catch(i){const s=ol(i,"Failed to persist write");t.reject(s)}}async function Ep(n,e){const t=J(n);try{const r=await Ow(t.localStore,e);e.targetChanges.forEach(((i,s)=>{const o=t.Eu.get(s);o&&(de(i.addedDocuments.size+i.modifiedDocuments.size+i.removedDocuments.size<=1,22616),i.addedDocuments.size>0?o.lu=!0:i.modifiedDocuments.size>0?de(o.lu,14607):i.removedDocuments.size>0&&(de(o.lu,42227),o.lu=!1))})),await Ji(t,r,e)}catch(r){await Pr(r)}}function Gd(n,e,t){const r=J(n);if(r.isPrimaryClient&&t===0||!r.isPrimaryClient&&t===1){const i=[];r.Pu.forEach(((s,o)=>{const c=o.view.va(e);c.snapshot&&i.push(c.snapshot)})),(function(o,c){const l=J(o);l.onlineState=c;let d=!1;l.queries.forEach(((f,p)=>{for(const m of p.wa)m.va(c)&&(d=!0)})),d&&ll(l)})(r.eventManager,e),i.length&&r.hu.J_(i),r.onlineState=e,r.isPrimaryClient&&r.sharedClientState.setOnlineState(e)}}async function E0(n,e,t){const r=J(n);r.sharedClientState.updateQueryState(e,"rejected",t);const i=r.Eu.get(e),s=i&&i.key;if(s){let o=new _e(H.comparator);o=o.insert(s,ze.newNoDocument(s,Q.min()));const c=oe().add(s),l=new Lo(Q.min(),new Map,new _e(re),o,c);await Ep(r,l),r.du=r.du.remove(s),r.Eu.delete(e),hl(r)}else await pc(r.localStore,e,!1).then((()=>yc(r,e,t))).catch(Pr)}async function I0(n,e){const t=J(n),r=e.batch.batchId;try{const i=await Nw(t.localStore,e);Tp(t,r,null),Ip(t,r),t.sharedClientState.updateMutationState(r,"acknowledged"),await Ji(t,i)}catch(i){await Pr(i)}}async function T0(n,e,t){const r=J(n);try{const i=await(function(o,c){const l=J(o);return l.persistence.runTransaction("Reject batch","readwrite-primary",(d=>{let f;return l.mutationQueue.lookupMutationBatch(d,c).next((p=>(de(p!==null,37113),f=p.keys(),l.mutationQueue.removeMutationBatch(d,p)))).next((()=>l.mutationQueue.performConsistencyCheck(d))).next((()=>l.documentOverlayCache.removeOverlaysForBatchId(d,f,c))).next((()=>l.localDocuments.recalculateAndSaveOverlaysForDocumentKeys(d,f))).next((()=>l.localDocuments.getDocuments(d,f)))}))})(r.localStore,e);Tp(r,e,t),Ip(r,e),r.sharedClientState.updateMutationState(e,"rejected",t),await Ji(r,i)}catch(i){await Pr(i)}}function Ip(n,e){(n.Vu.get(e)||[]).forEach((t=>{t.resolve()})),n.Vu.delete(e)}function Tp(n,e,t){const r=J(n);let i=r.Ru[r.currentUser.toKey()];if(i){const s=i.get(e);s&&(t?s.reject(t):s.resolve(),i=i.remove(e)),r.Ru[r.currentUser.toKey()]=i}}function yc(n,e,t=null){n.sharedClientState.removeLocalQueryTarget(e);for(const r of n.Tu.get(e))n.Pu.delete(r),t&&n.hu.pu(r,t);n.Tu.delete(e),n.isPrimaryClient&&n.Au.zr(e).forEach((r=>{n.Au.containsKey(r)||Ap(n,r)}))}function Ap(n,e){n.Iu.delete(e.path.canonicalString());const t=n.du.get(e);t!==null&&(tl(n.remoteStore,t),n.du=n.du.remove(e),n.Eu.delete(t),hl(n))}function Kd(n,e,t){for(const r of t)r instanceof _p?(n.Au.addReference(r.key,e),A0(n,r)):r instanceof wp?($(dl,"Document no longer in limbo: "+r.key),n.Au.removeReference(r.key,e),n.Au.containsKey(r.key)||Ap(n,r.key)):K(19791,{yu:r})}function A0(n,e){const t=e.key,r=t.path.canonicalString();n.du.get(t)||n.Iu.has(r)||($(dl,"New document in limbo: "+t),n.Iu.add(r),hl(n))}function hl(n){for(;n.Iu.size>0&&n.du.size<n.maxConcurrentLimboResolutions;){const e=n.Iu.values().next().value;n.Iu.delete(e);const t=new H(me.fromString(e)),r=n.mu.next();n.Eu.set(r,new p0(t)),n.du=n.du.insert(t,r),fp(n.remoteStore,new tn(bt(Ro(t.path)),r,"TargetPurposeLimboResolution",ko.ue))}}async function Ji(n,e,t){const r=J(n),i=[],s=[],o=[];r.Pu.isEmpty()||(r.Pu.forEach(((c,l)=>{o.push(r.gu(l,e,t).then((d=>{var f;if((d||t)&&r.isPrimaryClient){const p=d?!d.fromCache:(f=t==null?void 0:t.targetChanges.get(l.targetId))===null||f===void 0?void 0:f.current;r.sharedClientState.updateQueryState(l.targetId,p?"current":"not-current")}if(d){i.push(d);const p=Jc.Es(l.targetId,d);s.push(p)}})))})),await Promise.all(o),r.hu.J_(i),await(async function(l,d){const f=J(l);try{await f.persistence.runTransaction("notifyLocalViewChanges","readwrite",(p=>D.forEach(d,(m=>D.forEach(m.Is,(_=>f.persistence.referenceDelegate.addReference(p,m.targetId,_))).next((()=>D.forEach(m.ds,(_=>f.persistence.referenceDelegate.removeReference(p,m.targetId,_)))))))))}catch(p){if(!Dr(p))throw p;$(el,"Failed to update sequence numbers: "+p)}for(const p of d){const m=p.targetId;if(!p.fromCache){const _=f.Fs.get(m),C=_.snapshotVersion,x=_.withLastLimboFreeSnapshotVersion(C);f.Fs=f.Fs.insert(m,x)}}})(r.localStore,s))}async function x0(n,e){const t=J(n);if(!t.currentUser.isEqual(e)){$(dl,"User change. New user:",e.toKey());const r=await lp(t.localStore,e);t.currentUser=e,(function(s,o){s.Vu.forEach((c=>{c.forEach((l=>{l.reject(new F(P.CANCELLED,o))}))})),s.Vu.clear()})(t,"'waitForPendingWrites' promise is rejected due to a user change."),t.sharedClientState.handleUserChange(e,r.removedBatchIds,r.addedBatchIds),await Ji(t,r.Bs)}}function k0(n,e){const t=J(n),r=t.Eu.get(e);if(r&&r.lu)return oe().add(r.key);{let i=oe();const s=t.Tu.get(e);if(!s)return i;for(const o of s){const c=t.Pu.get(o);i=i.unionWith(c.view.tu)}return i}}function xp(n){const e=J(n);return e.remoteStore.remoteSyncer.applyRemoteEvent=Ep.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=k0.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=E0.bind(null,e),e.hu.J_=u0.bind(null,e.eventManager),e.hu.pu=d0.bind(null,e.eventManager),e}function S0(n){const e=J(n);return e.remoteStore.remoteSyncer.applySuccessfulWrite=I0.bind(null,e),e.remoteStore.remoteSyncer.rejectFailedWrite=T0.bind(null,e),e}class io{constructor(){this.kind="memory",this.synchronizeTabs=!1}async initialize(e){this.serializer=Mo(e.databaseInfo.databaseId),this.sharedClientState=this.bu(e),this.persistence=this.Du(e),await this.persistence.start(),this.localStore=this.vu(e),this.gcScheduler=this.Cu(e,this.localStore),this.indexBackfillerScheduler=this.Fu(e,this.localStore)}Cu(e,t){return null}Fu(e,t){return null}vu(e){return Dw(this.persistence,new Cw,e.initialUser,this.serializer)}Du(e){return new cp(Qc.Vi,this.serializer)}bu(e){return new Bw}async terminate(){var e,t;(e=this.gcScheduler)===null||e===void 0||e.stop(),(t=this.indexBackfillerScheduler)===null||t===void 0||t.stop(),this.sharedClientState.shutdown(),await this.persistence.shutdown()}}io.provider={build:()=>new io};class C0 extends io{constructor(e){super(),this.cacheSizeBytes=e}Cu(e,t){de(this.persistence.referenceDelegate instanceof no,46915);const r=this.persistence.referenceDelegate.garbageCollector;return new pw(r,e.asyncQueue,t)}Du(e){const t=this.cacheSizeBytes!==void 0?Je.withCacheSize(this.cacheSizeBytes):Je.DEFAULT;return new cp((r=>no.Vi(r,t)),this.serializer)}}class vc{async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=r=>Gd(this.syncEngine,r,1),this.remoteStore.remoteSyncer.handleCredentialChange=x0.bind(null,this.syncEngine),await a0(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return(function(){return new l0})()}createDatastore(e){const t=Mo(e.databaseInfo.databaseId),r=(function(s){return new qw(s)})(e.databaseInfo);return(function(s,o,c,l){return new Kw(s,o,c,l)})(e.authCredentials,e.appCheckCredentials,r,t)}createRemoteStore(e){return(function(r,i,s,o,c){return new Yw(r,i,s,o,c)})(this.localStore,this.datastore,e.asyncQueue,(t=>Gd(this.syncEngine,t,0)),(function(){return $d.C()?new $d:new Uw})())}createSyncEngine(e,t){return(function(i,s,o,c,l,d,f){const p=new m0(i,s,o,c,l,d);return f&&(p.fu=!0),p})(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}async terminate(){var e,t;await(async function(i){const s=J(i);$(Bn,"RemoteStore shutting down."),s.Ia.add(5),await Qi(s),s.Ea.shutdown(),s.Aa.set("Unknown")})(this.remoteStore),(e=this.datastore)===null||e===void 0||e.terminate(),(t=this.eventManager)===null||t===void 0||t.terminate()}}vc.provider={build:()=>new vc};/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class fl{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.xu(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.xu(this.observer.error,e):$t("Uncaught Error in snapshot listener:",e.toString()))}Ou(){this.muted=!0}xu(e,t){setTimeout((()=>{this.muted||e(t)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const mn="FirestoreClient";class R0{constructor(e,t,r,i,s){this.authCredentials=e,this.appCheckCredentials=t,this.asyncQueue=r,this.databaseInfo=i,this.user=je.UNAUTHENTICATED,this.clientId=$c.newId(),this.authCredentialListener=()=>Promise.resolve(),this.appCheckCredentialListener=()=>Promise.resolve(),this._uninitializedComponentsProvider=s,this.authCredentials.start(r,(async o=>{$(mn,"Received user=",o.uid),await this.authCredentialListener(o),this.user=o})),this.appCheckCredentials.start(r,(o=>($(mn,"Received new app check token=",o),this.appCheckCredentialListener(o,this.user))))}get configuration(){return{asyncQueue:this.asyncQueue,databaseInfo:this.databaseInfo,clientId:this.clientId,authCredentials:this.authCredentials,appCheckCredentials:this.appCheckCredentials,initialUser:this.user,maxConcurrentLimboResolutions:100}}setCredentialChangeListener(e){this.authCredentialListener=e}setAppCheckTokenChangeListener(e){this.appCheckCredentialListener=e}terminate(){this.asyncQueue.enterRestrictedMode();const e=new Bt;return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async()=>{try{this._onlineComponents&&await this._onlineComponents.terminate(),this._offlineComponents&&await this._offlineComponents.terminate(),this.authCredentials.shutdown(),this.appCheckCredentials.shutdown(),e.resolve()}catch(t){const r=ol(t,"Failed to shutdown persistence");e.reject(r)}})),e.promise}}async function La(n,e){n.asyncQueue.verifyOperationInProgress(),$(mn,"Initializing OfflineComponentProvider");const t=n.configuration;await e.initialize(t);let r=t.initialUser;n.setCredentialChangeListener((async i=>{r.isEqual(i)||(await lp(e.localStore,i),r=i)})),e.persistence.setDatabaseDeletedListener((()=>{ln("Terminating Firestore due to IndexedDb database deletion"),n.terminate().then((()=>{$("Terminating Firestore due to IndexedDb database deletion completed successfully")})).catch((i=>{ln("Terminating Firestore due to IndexedDb database deletion failed",i)}))})),n._offlineComponents=e}async function Zd(n,e){n.asyncQueue.verifyOperationInProgress();const t=await P0(n);$(mn,"Initializing OnlineComponentProvider"),await e.initialize(t,n.configuration),n.setCredentialChangeListener((r=>zd(e.remoteStore,r))),n.setAppCheckTokenChangeListener(((r,i)=>zd(e.remoteStore,i))),n._onlineComponents=e}async function P0(n){if(!n._offlineComponents)if(n._uninitializedComponentsProvider){$(mn,"Using user provided OfflineComponentProvider");try{await La(n,n._uninitializedComponentsProvider._offline)}catch(e){const t=e;if(!(function(i){return i.name==="FirebaseError"?i.code===P.FAILED_PRECONDITION||i.code===P.UNIMPLEMENTED:!(typeof DOMException<"u"&&i instanceof DOMException)||i.code===22||i.code===20||i.code===11})(t))throw t;ln("Error using user provided cache. Falling back to memory cache: "+t),await La(n,new io)}}else $(mn,"Using default OfflineComponentProvider"),await La(n,new C0(void 0));return n._offlineComponents}async function kp(n){return n._onlineComponents||(n._uninitializedComponentsProvider?($(mn,"Using user provided OnlineComponentProvider"),await Zd(n,n._uninitializedComponentsProvider._online)):($(mn,"Using default OnlineComponentProvider"),await Zd(n,new vc))),n._onlineComponents}function D0(n){return kp(n).then((e=>e.syncEngine))}async function so(n){const e=await kp(n),t=e.eventManager;return t.onListen=g0.bind(null,e.syncEngine),t.onUnlisten=_0.bind(null,e.syncEngine),t.onFirstRemoteStoreListen=y0.bind(null,e.syncEngine),t.onLastRemoteStoreUnlisten=w0.bind(null,e.syncEngine),t}function N0(n,e,t={}){const r=new Bt;return n.asyncQueue.enqueueAndForget((async()=>(function(s,o,c,l,d){const f=new fl({next:m=>{f.Ou(),o.enqueueAndForget((()=>cl(s,p)));const _=m.docs.has(c);!_&&m.fromCache?d.reject(new F(P.UNAVAILABLE,"Failed to get document because the client is offline.")):_&&m.fromCache&&l&&l.source==="server"?d.reject(new F(P.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):d.resolve(m)},error:m=>d.reject(m)}),p=new ul(Ro(c.path),f,{includeMetadataChanges:!0,ka:!0});return al(s,p)})(await so(n),n.asyncQueue,e,t,r))),r.promise}function O0(n,e,t={}){const r=new Bt;return n.asyncQueue.enqueueAndForget((async()=>(function(s,o,c,l,d){const f=new fl({next:m=>{f.Ou(),o.enqueueAndForget((()=>cl(s,p))),m.fromCache&&l.source==="server"?d.reject(new F(P.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):d.resolve(m)},error:m=>d.reject(m)}),p=new ul(c,f,{includeMetadataChanges:!0,ka:!0});return al(s,p)})(await so(n),n.asyncQueue,e,t,r))),r.promise}/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const F0=/^__.*__$/;class B0{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return this.fieldMask!==null?new wn(e,this.data,this.fieldMask,t,this.fieldTransforms):new Yi(e,this.data,t,this.fieldTransforms)}}class Rp{constructor(e,t,r){this.data=e,this.fieldMask=t,this.fieldTransforms=r}toMutation(e,t){return new wn(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function Pp(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw K(40011,{Ec:n})}}class pl{constructor(e,t,r,i,s,o){this.settings=e,this.databaseId=t,this.serializer=r,this.ignoreUndefinedProperties=i,s===void 0&&this.Ac(),this.fieldTransforms=s||[],this.fieldMask=o||[]}get path(){return this.settings.path}get Ec(){return this.settings.Ec}Rc(e){return new pl(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Vc(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Rc({path:r,mc:!1});return i.fc(e),i}gc(e){var t;const r=(t=this.path)===null||t===void 0?void 0:t.child(e),i=this.Rc({path:r,mc:!1});return i.Ac(),i}yc(e){return this.Rc({path:void 0,mc:!0})}wc(e){return oo(e,this.settings.methodName,this.settings.Sc||!1,this.path,this.settings.bc)}contains(e){return this.fieldMask.find((t=>e.isPrefixOf(t)))!==void 0||this.fieldTransforms.find((t=>e.isPrefixOf(t.field)))!==void 0}Ac(){if(this.path)for(let e=0;e<this.path.length;e++)this.fc(this.path.get(e))}fc(e){if(e.length===0)throw this.wc("Document fields must not be empty");if(Pp(this.Ec)&&F0.test(e))throw this.wc('Document fields cannot begin and end with "__"')}}class U0{constructor(e,t,r){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=r||Mo(e)}Dc(e,t,r,i=!1){return new pl({Ec:e,methodName:t,bc:r,path:Le.emptyPath(),mc:!1,Sc:i},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function ns(n){const e=n._freezeSettings(),t=Mo(n._databaseId);return new U0(n._databaseId,!!e.ignoreUndefinedProperties,t)}function ml(n,e,t,r,i,s={}){const o=n.Dc(s.merge||s.mergeFields?2:0,e,t,i);yl("Data must be an object, but it was:",o,r);const c=Op(r,o);let l,d;if(s.merge)l=new ot(o.fieldMask),d=o.fieldTransforms;else if(s.mergeFields){const f=[];for(const p of s.mergeFields){const m=_c(e,p,t);if(!o.contains(m))throw new F(P.INVALID_ARGUMENT,`Field '${m}' is specified in your field mask but missing from your input data.`);Lp(f,m)||f.push(m)}l=new ot(f),d=o.fieldTransforms.filter((p=>l.covers(p.field)))}else l=null,d=o.fieldTransforms;return new B0(new tt(c),l,d)}class jo extends $o{_toFieldTransform(e){if(e.Ec!==2)throw e.Ec===1?e.wc(`${this._methodName}() can only appear at the top level of your update data`):e.wc(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof jo}}class gl extends $o{_toFieldTransform(e){return new N_(e.path,new Ai)}isEqual(e){return e instanceof gl}}function Dp(n,e,t,r){const i=n.Dc(1,e,t);yl("Data must be an object, but it was:",i,r);const s=[],o=tt.empty();_n(r,((l,d)=>{const f=vl(e,l,t);d=Se(d);const p=i.gc(f);if(d instanceof jo)s.push(f);else{const m=rs(d,p);m!=null&&(s.push(f),o.set(f,m))}}));const c=new ot(s);return new Rp(o,c,i.fieldTransforms)}function Np(n,e,t,r,i,s){const o=n.Dc(1,e,t),c=[_c(e,r,t)],l=[i];if(s.length%2!=0)throw new F(P.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let m=0;m<s.length;m+=2)c.push(_c(e,s[m])),l.push(s[m+1]);const d=[],f=tt.empty();for(let m=c.length-1;m>=0;--m)if(!Lp(d,c[m])){const _=c[m];let C=l[m];C=Se(C);const x=o.gc(_);if(C instanceof jo)d.push(_);else{const A=rs(C,x);A!=null&&(d.push(_),f.set(_,A))}}const p=new ot(d);return new Rp(f,p,o.fieldTransforms)}function $0(n,e,t,r=!1){return rs(t,n.Dc(r?4:3,e))}function rs(n,e){if(Vp(n=Se(n)))return yl("Unsupported field value:",e,n),Op(n,e);if(n instanceof $o)return(function(r,i){if(!Pp(i.Ec))throw i.wc(`${r._methodName}() can only be used with update() and set()`);if(!i.path)throw i.wc(`${r._methodName}() is not currently supported inside arrays`);const s=r._toFieldTransform(i);s&&i.fieldTransforms.push(s)})(n,e),null;if(n===void 0&&e.ignoreUndefinedProperties)return null;if(e.path&&e.fieldMask.push(e.path),n instanceof Array){if(e.settings.mc&&e.Ec!==4)throw e.wc("Nested arrays are not supported");return(function(r,i){const s=[];let o=0;for(const c of r){let l=rs(c,i.yc(o));l==null&&(l={nullValue:"NULL_VALUE"}),s.push(l),o++}return{arrayValue:{values:s}}})(n,e)}return(function(r,i){if((r=Se(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return R_(i.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){const s=ye.fromDate(r);return{timestampValue:to(i.serializer,s)}}if(r instanceof ye){const s=new ye(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:to(i.serializer,s)}}if(r instanceof It)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof lt)return{bytesValue:ep(i.serializer,r._byteString)};if(r instanceof be){const s=i.databaseId,o=r.firestore._databaseId;if(!o.isEqual(s))throw i.wc(`Document reference is for database ${o.projectId}/${o.database} but should be for database ${s.projectId}/${s.database}`);return{referenceValue:Yc(r.firestore._databaseId||i.databaseId,r._key.path)}}if(r instanceof Tt)return(function(o,c){return{mapValue:{fields:{[Cf]:{stringValue:Rf},[Qs]:{arrayValue:{values:o.toArray().map((d=>{if(typeof d!="number")throw c.wc("VectorValues must only contain numeric values.");return Gc(c.serializer,d)}))}}}}}})(r,i);throw i.wc(`Unsupported field value: ${xo(r)}`)})(n,e)}function Op(n,e){const t={};return If(n)?e.path&&e.path.length>0&&e.fieldMask.push(e.path):_n(n,((r,i)=>{const s=rs(i,e.Vc(r));s!=null&&(t[r]=s)})),{mapValue:{fields:t}}}function Vp(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ye||n instanceof It||n instanceof lt||n instanceof be||n instanceof $o||n instanceof Tt)}function yl(n,e,t){if(!Vp(t)||!bf(t)){const r=xo(t);throw r==="an object"?e.wc(n+" a custom object"):e.wc(n+" "+r)}}function _c(n,e,t){if((e=Se(e))instanceof ts)return e._internalPath;if(typeof e=="string")return vl(n,e);throw oo("Field path arguments must be of type string or ",n,!1,void 0,t)}const j0=new RegExp("[~\\*/\\[\\]]");function vl(n,e,t){if(e.search(j0)>=0)throw oo(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,t);try{return new ts(...e.split("."))._internalPath}catch{throw oo(`Invalid field path (${e}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,t)}}function oo(n,e,t,r,i){const s=r&&!r.isEmpty(),o=i!==void 0;let c=`Function ${e}() called with invalid data`;t&&(c+=" (via `toFirestore()`)"),c+=". ";let l="";return(s||o)&&(l+=" (found",s&&(l+=` in field ${r}`),o&&(l+=` in document ${i}`),l+=")"),new F(P.INVALID_ARGUMENT,c+n+l)}function Lp(n,e){return n.some((t=>t.isEqual(e)))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $p(n){n=Ze(n,be);const e=Ze(n.firestore,Ct);return N0(es(e),n._key).then((t=>zp(e,n,t)))}On._jsonSchemaVersion="firestore/querySnapshot/1.0",On._jsonSchema={type:Ae("string",On._jsonSchemaVersion),bundleSource:Ae("string","QuerySnapshot"),bundleName:Ae("string"),bundle:Ae("string")};class Al extends q0{constructor(e){super(),this.firestore=e}convertBytes(e){return new lt(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new be(this.firestore,null,t)}}function Ho(n){n=Ze(n,bn);const e=Ze(n.firestore,Ct),t=es(e),r=new Al(e);return Fp(n._query),O0(t,n._query).then((i=>new On(e,r,n,i)))}function jp(n,e,t){n=Ze(n,be);const r=Ze(n.firestore,Ct),i=Tl(n.converter,e,t);return is(r,[ml(ns(r),"setDoc",n._key,i,n.converter!==null,t).toMutation(n._key,Ye.none())])}function Wo(n,e,t,...r){n=Ze(n,be);const i=Ze(n.firestore,Ct),s=ns(i);let o;return o=typeof(e=Se(e))=="string"||e instanceof ts?Np(s,"updateDoc",n._key,e,t,r):Dp(s,"updateDoc",n._key,e),is(i,[o.toMutation(n._key,Ye.exists(!0))])}function xl(n){return is(Ze(n.firestore,Ct),[new Vo(n._key,Ye.none())])}function Go(n,e){const t=Ze(n.firestore,Ct),r=Hn(n),i=Tl(n.converter,e);return is(t,[ml(ns(n.firestore),"addDoc",r._key,i,n.converter!==null,{}).toMutation(r._key,Ye.exists(!1))]).then((()=>r))}function Vr(n,...e){var t,r,i;n=Se(n);let s={includeMetadataChanges:!1,source:"default"},o=0;typeof e[o]!="object"||nh(e[o])||(s=e[o++]);const c={includeMetadataChanges:s.includeMetadataChanges,source:s.source};if(nh(e[o])){const p=e[o];e[o]=(t=p.next)===null||t===void 0?void 0:t.bind(p),e[o+1]=(r=p.error)===null||r===void 0?void 0:r.bind(p),e[o+2]=(i=p.complete)===null||i===void 0?void 0:i.bind(p)}let l,d,f;if(n instanceof be)d=Ze(n.firestore,Ct),f=Ro(n._key.path),l={next:p=>{e[o]&&e[o](zp(d,n,p))},error:e[o+1],complete:e[o+2]};else{const p=Ze(n,bn);d=Ze(p.firestore,Ct),f=p._query;const m=new Al(d);l={next:_=>{e[o]&&e[o](new On(d,m,p,_))},error:e[o+1],complete:e[o+2]},Fp(n._query)}return(function(m,_,C,x){const A=new fl(x),N=new ul(_,A,C);return m.asyncQueue.enqueueAndForget((async()=>al(await so(m),N))),()=>{A.Ou(),m.asyncQueue.enqueueAndForget((async()=>cl(await so(m),N)))}})(es(d),f,c,l)}function is(n,e){return(function(r,i){const s=new Bt;return r.asyncQueue.enqueueAndForget((async()=>b0(await D0(r),i,s))),s.promise})(es(n),e)}function zp(n,e,t){const r=t.docs.get(e._key),i=new Al(n);return new Nn(n,i,e._key,r,new oi(t.hasPendingWrites,t.fromCache),e.converter)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ao=new Mc("@firebase/auth");function K0(n,...e){ao.logLevel<=se.WARN&&ao.warn(`Auth (${Cr}): ${n}`,...e)}function Us(n,...e){ao.logLevel<=se.ERROR&&ao.error(`Auth (${Cr}): ${n}`,...e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function yi(n){if(n)try{const e=new Date(Number(n));if(!isNaN(e.getTime()))return e.toUTCString()}catch{}}async function rb(n,e=!1){const t=Se(n),r=await t.getIdToken(e),i=Rl(r);X(i&&i.exp&&i.auth_time&&i.iat,t.auth,"internal-error");const s=typeof i.firebase=="object"?i.firebase:void 0,o=s==null?void 0:s.sign_in_provider;return{claims:i,token:r,authTime:yi(Fa(i.auth_time)),issuedAtTime:yi(Fa(i.iat)),expirationTime:yi(Fa(i.exp)),signInProvider:o||null,signInSecondFactor:(s==null?void 0:s.sign_in_second_factor)||null}}function Fa(n){return Number(n)*1e3}function Rl(n){const[e,t,r]=n.split(".");if(e===void 0||t===void 0||r===void 0)return Us("JWT malformed, contained fewer than 3 sections"),null;try{const i=Qh(t);return i?JSON.parse(i):(Us("Failed to decode base64 JWT payload"),null)}catch(i){return Us("Caught error parsing JWT payload as JSON",i==null?void 0:i.toString()),null}}function oh(n){const e=Rl(n);return X(e,"internal-error"),X(typeof e.exp<"u","internal-error"),X(typeof e.iat<"u","internal-error"),Number(e.exp)-Number(e.iat)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function lo(n){var e;const t=n.auth,r=await n.getIdToken(),i=await Si(n,co(t,{idToken:r}));X(i==null?void 0:i.users.length,t,"internal-error");const s=i.users[0];n._notifyReloadListener(s);const o=!((e=s.providerUserInfo)===null||e===void 0)&&e.length?Qp(s.providerUserInfo):[],c=ab(n.providerData,o),l=n.isAnonymous,d=!(n.email&&s.passwordHash)&&!(c!=null&&c.length),f=l?d:!1,p={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:c,metadata:new bc(s.createdAt,s.lastLoginAt),isAnonymous:f};Object.assign(n,p)}async function ob(n){const e=Se(n);await lo(e),await e.auth._persistUserIfCurrent(e),e.auth._notifyListenersIfCurrent(e)}function ab(n,e){return[...n.filter(r=>!e.some(i=>i.providerId===r.providerId)),...e]}function Qp(n){return n.map(e=>{var{providerId:t}=e,r=kl(e,["providerId"]);return{providerId:t,uid:r.rawId||"",displayName:r.displayName||null,email:r.email||null,phoneNumber:r.phoneNumber||null,photoURL:r.photoUrl||null}})}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $s(n,e,t){return`firebase:${n}:${e}:${t}`}class pr{constructor(e,t,r){this.persistence=e,this.auth=t,this.userKey=r;const{config:i,name:s}=this.auth;this.fullUserKey=$s(this.userKey,i.apiKey,s),this.fullPersistenceKey=$s("persistence",i.apiKey,s),this.boundEventHandler=t._onStorageEvent.bind(t),this.persistence._addListener(this.fullUserKey,this.boundEventHandler)}setCurrentUser(e){return this.persistence._set(this.fullUserKey,e.toJSON())}async getCurrentUser(){const e=await this.persistence._get(this.fullUserKey);if(!e)return null;if(typeof e=="string"){const t=await co(this.auth,{idToken:e}).catch(()=>{});return t?mt._fromGetAccountInfoResponse(this.auth,t,e):null}return mt._fromJSON(this.auth,e)}removeCurrentUser(){return this.persistence._remove(this.fullUserKey)}savePersistenceForRedirect(){return this.persistence._set(this.fullPersistenceKey,this.persistence.type)}async setPersistence(e){if(this.persistence===e)return;const t=await this.getCurrentUser();if(await this.removeCurrentUser(),this.persistence=e,t)return this.setCurrentUser(t)}delete(){this.persistence._removeListener(this.fullUserKey,this.boundEventHandler)}static async create(e,t,r="authUser"){if(!t.length)return new pr(Ft(ch),e,r);const i=(await Promise.all(t.map(async d=>{if(await d._isAvailable())return d}))).filter(d=>d);let s=i[0]||Ft(ch);const o=$s(r,e.config.apiKey,e.name);let c=null;for(const d of t)try{const f=await d._get(o);if(f){let p;if(typeof f=="string"){const m=await co(e,{idToken:f}).catch(()=>{});if(!m)break;p=await mt._fromGetAccountInfoResponse(e,m,f)}else p=mt._fromJSON(e,f);d!==s&&(c=p),s=d;break}}catch{}const l=i.filter(d=>d._shouldAllowMigration);return!s._shouldAllowMigration||!l.length?new pr(s,e,r):(s=l[0],c&&await s._set(o,c.toJSON()),await Promise.all(t.map(async d=>{if(d!==s)try{await d._remove(o)}catch{}})),new pr(s,e,r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bb(n,e){const t=Bc(n,"auth");if(t.isInitialized()){const i=t.getImmediate(),s=t.getOptions();if(Ln(s,e??{}))return i;zt(i,"already-initialized")}return t.initialize({options:e})}function Eb(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(Ft);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function Ib(n,e,t){const r=Zo(n);X(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const i=!1,s=lm(e),{host:o,port:c}=Tb(e),l=c===null?"":`:${c}`,d={url:`${s}//${o}${l}/`},f=Object.freeze({host:o,port:c,protocol:s.replace(":",""),options:Object.freeze({disableWarnings:i})});if(!r._canInitEmulator){X(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),X(Ln(d,r.config.emulator)&&Ln(f,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=d,r.emulatorConfig=f,r.settings.appVerificationDisabledForTesting=!0,Sr(o)?(nf(`${s}//${o}${l}`),rf("Auth",!0)):Ab()}function lm(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function Tb(n){const e=lm(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",i=/^(\[[^\]]+\])(:|$)/.exec(r);if(i){const s=i[1];return{host:s,port:dh(r.substr(s.length+1))}}else{const[s,o]=r.split(":");return{host:s,port:dh(o)}}}function dh(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function Ab(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Xt extends os{constructor(){super("facebook.com")}static credential(e){return Un._fromParams({providerId:Xt.PROVIDER_ID,signInMethod:Xt.FACEBOOK_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Xt.credentialFromTaggedObject(e)}static credentialFromError(e){return Xt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Xt.credential(e.oauthAccessToken)}catch{return null}}}Xt.FACEBOOK_SIGN_IN_METHOD="facebook.com";Xt.PROVIDER_ID="facebook.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Jt extends os{constructor(){super("github.com")}static credential(e){return Un._fromParams({providerId:Jt.PROVIDER_ID,signInMethod:Jt.GITHUB_SIGN_IN_METHOD,accessToken:e})}static credentialFromResult(e){return Jt.credentialFromTaggedObject(e)}static credentialFromError(e){return Jt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e||!("oauthAccessToken"in e)||!e.oauthAccessToken)return null;try{return Jt.credential(e.oauthAccessToken)}catch{return null}}}Jt.GITHUB_SIGN_IN_METHOD="github.com";Jt.PROVIDER_ID="github.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class en extends os{constructor(){super("twitter.com")}static credential(e,t){return Un._fromParams({providerId:en.PROVIDER_ID,signInMethod:en.TWITTER_SIGN_IN_METHOD,oauthToken:e,oauthTokenSecret:t})}static credentialFromResult(e){return en.credentialFromTaggedObject(e)}static credentialFromError(e){return en.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthAccessToken:t,oauthTokenSecret:r}=e;if(!t||!r)return null;try{return en.credential(t,r)}catch{return null}}}en.TWITTER_SIGN_IN_METHOD="twitter.com";en.PROVIDER_ID="twitter.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uo extends Wt{constructor(e,t,r,i){var s;super(t.code,t.message),this.operationType=r,this.user=i,Object.setPrototypeOf(this,uo.prototype),this.customData={appName:e.name,tenantId:(s=e.tenantId)!==null&&s!==void 0?s:void 0,_serverResponse:t.customData._serverResponse,operationType:r}}static _fromErrorAndOperation(e,t,r,i){return new uo(e,t,r,i)}}function hm(n,e,t,r){return(e==="reauthenticate"?t._getReauthenticationResolver(n):t._getIdTokenResponse(n)).catch(s=>{throw s.code==="auth/multi-factor-auth-required"?uo._fromErrorAndOperation(n,s,e,r):s})}async function Cb(n,e,t=!1){const r=await Si(n,e._linkToIdToken(n.auth,await n.getIdToken()),t);return gn._forOperation(n,"link",r)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class bm{constructor(e,t,r,i,s=!1){this.auth=e,this.resolver=r,this.user=i,this.bypassAuthState=s,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}execute(){return new Promise(async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(r){this.reject(r)}})}async onAuthEvent(e){const{urlResponse:t,sessionId:r,postBody:i,tenantId:s,error:o,type:c}=e;if(o){this.reject(o);return}const l={auth:this.auth,requestUri:t,sessionId:r,tenantId:s||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(c)(l))}catch(d){this.reject(d)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return Xb;case"linkViaPopup":case"linkViaRedirect":return Jb;case"reauthViaPopup":case"reauthViaRedirect":return Qb;default:zt(this.auth,"internal-error")}}resolve(e){qt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){qt(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ba="webStorageSupport";class ME{constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=gm,this._completeRedirectFn=aE,this._overrideRedirectResult=iE}async _openPopup(e,t,r,i){var s;qt((s=this.eventManagers[e._key()])===null||s===void 0?void 0:s.manager,"_initialize() not called before _openPopup()");const o=await vh(e,t,r,wc(),i);return PE(e,o,Nl())}async _openRedirect(e,t,r,i){await this._originValidation(e);const s=await vh(e,t,r,wc(),i);return Ub(s),new Promise(()=>{})}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:i,promise:s}=this.eventManagers[t];return i?Promise.resolve(i):(qt(s,"If manager is not set, promise should be"),s)}const r=this.initAndGetManager(e);return this.eventManagers[t]={promise:r},r.catch(()=>{delete this.eventManagers[t]}),r}async initAndGetManager(e){const t=await AE(e),r=new lE(e);return t.register("authEvent",i=>(X(i==null?void 0:i.authEvent,e,"invalid-auth-event"),{status:r.onEvent(i.authEvent)?"ACK":"ERROR"}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:r},this.iframes[e._key()]=t,r}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send(Ba,{type:Ba},i=>{var s;const o=(s=i==null?void 0:i[0])===null||s===void 0?void 0:s[Ba];o!==void 0&&t(!!o),zt(e,"internal-error")},gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=pE(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return am()||tm()||Pl()}}const FE=ME;var _h="@firebase/auth",wh="1.10.8";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function UE(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function $E(n){gr(new Mn("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),i=e.getProvider("heartbeat"),s=e.getProvider("app-check-internal"),{apiKey:o,authDomain:c}=r.options;X(o&&!o.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:o,authDomain:c,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:cm(n)},d=new gb(r,i,s,l);return Eb(d,t),d},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),gr(new Mn("auth-internal",e=>{const t=Zo(e.getProvider("auth").getImmediate());return(r=>new BE(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),sn(_h,wh,UE(n)),sn(_h,wh,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/async function LA(n,e){try{return await VA(n,{progress:(i,s,o)=>{if(e){const c=Math.round(s*100);e(`${i}: ${c}%`)}},output:{type:"image/png",quality:.8}})}catch(t){throw console.error("Background removal failed:",t),t}}function Ha(n,e){let t;return function(...r){clearTimeout(t),t=setTimeout(()=>n(...r),e)}}let y={boardId:null,board:null,tool:"select",viewport:{x:0,y:0,zoom:1},elements:new Map,selectedIds:[],isPanning:!1,isDragging:!1,isResizing:!1,isDrawing:!1,drawColor:"#111111",drawWidth:3,noteColor:"yellow",panStart:{x:0,y:0},dragStart:{x:0,y:0},dragOffset:{x:0,y:0},resizeStart:null,drawingPoints:[],lastPresenceUpdate:0,isConnecting:!1,connectionStartId:null,tempConnectionLine:null,connections:[],replyElementId:null,currentTemplate:null,isWaitingForGen:!1},ui=null,di=null,Gs=null,ee={};const G={sparkles:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3l2 5 5 2-5 2-2 5-2-5-5-2 5-2 2-5z"/></svg>',arrow_tool:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="5" y1="19" x2="19" y2="5"/><polyline points="9 5 19 5 19 15"/></svg>',ellipse_tool:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/></svg>',rectangle_tool:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/></svg>',diamond_tool:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 22 12 12 22 2 12 12 2"/></svg>',triangle_tool:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 4L4 20H20L12 4Z"/></svg>',line_tool:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="4" y1="20" x2="20" y2="4"/></svg>',cursor:'<svg viewBox="0 0 24 24" fill="currentColor"><path d="M6 3l6.5 18 2.5-6.5L21.5 12z"/></svg>',image:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>',video:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="6" width="20" height="12" rx="2" ry="2"/><polygon points="10 9 15 12 10 15 10 9"/></svg>',audio:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M12 4v16M8 8v8M16 8v8M4 11v2M20 11v2"/></svg>',frame:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="18" height="18" rx="2" stroke-dasharray="4 2"/></svg>',pan:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 11V6a2 2 0 0 0-4 0v5"/><path d="M14 10V4a2 2 0 0 0-4 0v6"/><path d="M10 10.5V5a2 2 0 0 0-4 0v9"/><path d="M18 11a2 2 0 1 1 4 0v3a8 8 0 0 1-8 8h-2c-2.76 0-5.26-1.12-7.07-2.93l-3.43-3.43a2 2 0 0 1 2.83-2.83L8 15"/></svg>',draw_scribble:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3c-1.1 0-2 .9-2 2v2H8c-1.1 0-2 .9-2 2v2h4V7h4v2h4V7h-4V5c0-1.1-.9-2-2-2zM4 11c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2s2-.9 2-2v-6c0-1.1-.9-2-2-2zm16 0c-1.1 0-2 .9-2 2v6c0 1.1.9 2 2 2s2-.9 2-2v-6c0-1.1-.9-2-2-2z"/></svg>',pencil:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"/></svg>',text_aa:'<svg viewBox="0 0 24 24" fill="currentColor" stroke="none"><text x="50%" y="65%" dominant-baseline="middle" text-anchor="middle" font-weight="700" font-size="18">Aa</text></svg>',pen:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 19l7-7 3 3-7 7-3-3zM12 19l-7-7 3-3 7 7-3 3z"/></svg>',text:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><text x="50%" y="65%" dominant-baseline="middle" text-anchor="middle" font-weight="700" font-size="18">Aa</text></svg>',eraser:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 20H7L3 16l8-8 9 9-4 3z"/><path d="M6.5 13.5L15 5l4 4"/></svg>',note:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M15.5 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V8.5L15.5 3z"/><polyline points="14 3 14 8 21 8"/></svg>',color:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="8"/><circle cx="12" cy="12" r="5" fill="currentColor"/></svg>',plus_circle:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><circle cx="12" cy="12" r="9"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></svg>',bot:'<svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>',download:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>',trash:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',heart:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',heartFill:'<svg viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="1"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>',back:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="15 18 9 12 15 6"/></svg>',settings:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z"/></svg>',share:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="18" cy="5" r="3"/><circle cx="6" cy="12" r="3"/><circle cx="18" cy="19" r="3"/><line x1="8.59" y1="13.51" x2="15.42" y2="17.49"/><line x1="15.41" y1="6.51" x2="8.59" y2="10.49"/></svg>',zoomIn:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="11" y1="8" x2="11" y2="14"/><line x1="8" y1="11" x2="14" y2="11"/></svg>',zoomOut:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="11" cy="11" r="8"/><line x1="21" y1="21" x2="16.65" y2="16.65"/><line x1="8" y1="11" x2="14" y2="11"/></svg>',wand:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m15 4 5 2"/><path d="m15 11 3 3"/><path d="m20 11 3-3"/><path d="m9 15 3 3"/><path d="M2.5 17.5 16 4"/><path d="m16 4 4 4L6.5 21.5 2.5 17.5Z"/></svg>',phone:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="14" height="20" x="5" y="2" rx="2" ry="2"/><path d="M12 18h.01"/></svg>',grid:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/></svg>',bold:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M6 4h8a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"/><path d="M6 12h9a4 4 0 0 1 4 4 4 4 0 0 1-4 4H6z"/></svg>',italic:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="19" y1="4" x2="10" y2="4"/><line x1="14" y1="20" x2="5" y2="20"/><line x1="15" y1="4" x2="9" y2="20"/></svg>',underline:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 3v7a6 6 0 0 0 12 0V3"/><line x1="4" y1="21" x2="20" y2="21"/></svg>',strike:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 4H9a3 3 0 0 0-2.83 4"/><path d="M14 12a4 4 0 0 1 0 8H6"/><line x1="4" y1="12" x2="20" y2="12"/></svg>',list:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="8" y1="6" x2="21" y2="6"/><line x1="8" y1="12" x2="21" y2="12"/><line x1="8" y1="18" x2="21" y2="18"/><line x1="3" y1="6" x2="3.01" y2="6"/><line x1="3" y1="12" x2="3.01" y2="12"/><line x1="3" y1="18" x2="3.01" y2="18"/></svg>',code:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>',chevron_down:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"/></svg>'};function qe(n,e){return{x:(n-y.viewport.x)/y.viewport.zoom,y:(e-y.viewport.y)/y.viewport.zoom}}function Wa(n,e){return{x:n*y.viewport.zoom+y.viewport.x,y:e*y.viewport.zoom+y.viewport.y}}function vi(){if(!ee.container)return;const{x:n,y:e,zoom:t}=y.viewport;if(ee.container.style.transform=`translate(${n}px, ${e}px) scale(${t})`,ee.wrapper){const r=24*t,i=n%r,s=e%r;ee.wrapper.style.backgroundSize=`${r}px ${r}px`,ee.wrapper.style.backgroundPosition=`${i}px ${s}px`}ee.zoomIndicator&&(ee.zoomIndicator.textContent=`${Math.round(t*100)}%`),ee.redrawStrokes&&ee.redrawStrokes()}function MA(n){return`
  ...
  `}function ue(n,e="info"){const t=document.getElementById("toast-container");if(!t)return;const r=document.createElement("div");r.className=`toast ${e}`,r.textContent=n,t.appendChild(r),setTimeout(()=>{r.style.opacity="0",r.style.transform="translateY(8px)",setTimeout(()=>r.remove(),300)},3e3)}function FA(n){const e=document.createElement("div");if(e.className="board-element",e.dataset.elementId=n.id,e.style.left=`${n.x||0}px`,e.style.top=`${n.y||0}px`,e.style.width=`${n.width||200}px`,e.style.height=n.height?`${n.height}px`:"auto",e.style.zIndex=n.zIndex||1,n.type==="image"){const t=document.createElement("div");t.className="connection-anchor connection-anchor-left",t.title="Drag to connect",t.dataset.side="left",e.appendChild(t);const r=document.createElement("div");r.className="connection-anchor connection-anchor-right",r.title="Drag to connect",r.dataset.side="right",e.appendChild(r)}switch(n.type){case"node-prompt":e.style.width="300px",e.innerHTML=`
      ...
      `,setTimeout(()=>{const r=e.querySelector(".ig-slides"),i=e.querySelectorAll(".ig-dot");r&&r.addEventListener("scroll",()=>{const s=Math.round(r.scrollLeft/r.offsetWidth);i.forEach((o,c)=>o.classList.toggle("active",c===s))})},100);break;case"drawing":return null}return e}function To(n,e=!1){e?n.forEach(i=>{if(y.selectedIds.includes(i)){y.selectedIds=y.selectedIds.filter(o=>o!==i);const s=y.elements.get(i);s!=null&&s.dom&&s.dom.classList.remove("selected")}else y.selectedIds.push(i)}):(y.selectedIds.forEach(i=>{const s=y.elements.get(i);s!=null&&s.dom&&s.dom.classList.remove("selected")}),y.selectedIds=n);const t=document.getElementById("img-ctx-menu");y.selectedIds.forEach(i=>{const s=y.elements.get(i);s!=null&&s.dom&&s.dom.classList.add("selected")});const r=y.selectedIds[y.selectedIds.length-1];if(y.selectedIds.length===1&&r){const i=y.elements.get(r);if((i==null?void 0:i.data.type)==="image"&&t){const s=i.dom.getBoundingClientRect();t.style.display="flex",t.style.left=`${s.left+s.width/2}px`,t.style.top=`${s.top-5}px`,document.getElementById("img-ctx-full").onclick=o=>{o.stopPropagation(),Tg(i.data.src)},document.getElementById("img-ctx-download").onclick=o=>{o.stopPropagation();const c=document.createElement("a");c.href=i.data.src,c.download=`board-image-${Date.now()}`,document.body.appendChild(c),c.click(),document.body.removeChild(c)},document.getElementById("img-ctx-crop").onclick=o=>{o.stopPropagation(),ue("Crop feature activated"),i.dom.style.overflow="hidden"}}else t&&(t.style.display="none")}else t&&(t.style.display="none")}function BA(n,e){const t=ee.wrapper;if(!n||!t)return;n.addEventListener("dblclick",o=>{if(o.stopPropagation(),e.type==="note"||e.type==="text"){const c=n.querySelector(".board-note, .board-text-el");if(c){c.contentEditable="true",e.type==="text"&&c.innerHTML==="Type here..."&&(c.innerHTML=""),c.focus(),zA(n,e);const l=Ha(()=>{ve(y.boardId,e.id,{content:c.innerHTML})},500);c.addEventListener("input",l),c.addEventListener("blur",()=>{c.contentEditable="false",ve(y.boardId,e.id,{content:c.innerHTML}),setTimeout(()=>{document.activeElement.closest(".text-format-popover")||(document.getElementById("text-format-popover").style.display="none")},100)},{once:!0})}}else e.type==="image"&&Tg(e.src)});const r=n.querySelector(".note-delete");r&&r.addEventListener("click",o=>{o.stopPropagation(),Ci(y.boardId,e.id)});const i=n.querySelector(".image-favorite");i&&i.addEventListener("click",o=>{o.stopPropagation();const c=!e.favorite;e.favorite=c,i.className=`image-favorite ${c?"active":""}`,i.innerHTML=c?G.heartFill:G.heart,ve(y.boardId,e.id,{favorite:c})}),n.querySelectorAll(".connection-anchor").forEach(o=>{o.addEventListener("mousedown",c=>{c.stopPropagation(),c.preventDefault();const l=qe(c.clientX,c.clientY);y.isConnecting=!0,y.connectionStartId=e.id;const d=document.getElementById("connection-layer");if(d){const f=document.createElementNS("http://www.w3.org/2000/svg","line"),m=o.dataset.side==="left"?e.x:e.x+(e.width||200),_=e.y+(e.height||200)/2;f.setAttribute("x1",m),f.setAttribute("y1",_),f.setAttribute("x2",l.x),f.setAttribute("y2",l.y),f.classList.add("temp-line"),d.appendChild(f),y.tempConnectionLine=f}})}),n.querySelectorAll(".image-action-btn").forEach(o=>{o.addEventListener("click",c=>{c.stopPropagation();const l=o.dataset.action;l==="remove-bg"&&Ig(e.id),l==="download"&&Ag(e.src,e.fileName||"image"),l==="delete-img"&&Ci(y.boardId,e.id)})});const s=n.querySelector(".board-frame-title");if(s){const o=Ha(()=>{ve(y.boardId,e.id,{title:s.textContent})},500);s.addEventListener("input",o),s.addEventListener("blur",()=>{ve(y.boardId,e.id,{title:s.textContent})})}if(n.addEventListener("mousedown",o=>{if(y.tool!=="select"&&y.tool!=="pan"||o.target.closest('.note-delete, .image-favorite, .image-action-btn, [contenteditable="true"]'))return;if(o.target.classList.contains("resize-handle")){UA(o,e);return}o.stopPropagation(),To([e.id],o.shiftKey);const c=qe(o.clientX,o.clientY);y.isDragging=!0,y.dragStart={x:c.x,y:c.y},y.dragOffset={x:c.x-(e.x||0),y:c.y-(e.y||0)};const l=f=>{if(!y.isDragging)return;const p=qe(f.clientX,f.clientY),m=p.x-y.dragOffset.x,_=p.y-y.dragOffset.y;n.style.left=`${m}px`,n.style.top=`${_}px`,e.x=m,e.y=_},d=()=>{y.isDragging&&(y.isDragging=!1,ve(y.boardId,e.id,{x:e.x,y:e.y})),window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",d)};window.addEventListener("mousemove",l),window.addEventListener("mouseup",d)}),n.addEventListener("contextmenu",o=>{o.preventDefault(),o.stopPropagation(),Eg(o.clientX,o.clientY,e)}),n.addEventListener("click",o=>{e.type==="image"&&y.tool==="select"&&(o.stopPropagation(),Oc(e.id))}),e.type==="node-prompt"||e.type==="node-enhancer"){const o=n.querySelector("textarea");if(o&&e.type==="node-prompt"){const l=Ha(()=>{ve(y.boardId,e.id,{content:o.value})},500);o.addEventListener("input",l),o.addEventListener("mousedown",d=>d.stopPropagation())}const c=n.querySelector(".run-model-btn");c&&c.addEventListener("click",async l=>{l.stopPropagation(),ex(e.id)})}}function UA(n,e){n.stopPropagation(),n.preventDefault();const t=y.elements.get(e.id);if(!t)return;const r=t.dom;y.isResizing=!0;const i=n.clientX,s=n.clientY,o=e.width||200,c=e.height||200,l=f=>{const p=(f.clientX-i)/y.viewport.zoom,m=(f.clientY-s)/y.viewport.zoom,_=Math.max(80,o+p),C=Math.max(60,c+m);r.style.width=`${_}px`,r.style.height=`${C}px`,e.width=_,e.height=C},d=()=>{y.isResizing=!1,ve(y.boardId,e.id,{width:e.width,height:e.height}),window.removeEventListener("mousemove",l),window.removeEventListener("mouseup",d)};window.addEventListener("mousemove",l),window.addEventListener("mouseup",d)}function Eg(n,e,t){var o;Ga();const r=document.createElement("div");r.className="context-menu",r.id="context-menu",r.style.left=`${n}px`,r.style.top=`${e}px`;let i="";t?(t.type==="note"&&(i+=`
